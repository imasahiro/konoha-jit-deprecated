...
#define TT_MAPMAP                       ((knh_token_t)8)
#define TT_FUNCTION                     ((knh_token_t)9)
#define TT_FORMAT                       ((knh_token_t)10)
#define TT_RETURN                       ((knh_token_t)11)
#define TT_WEAVE                        ((knh_token_t)12)
#define TT_ASPECT                       ((knh_token_t)13)
#define TT_IF                           ((knh_token_t)14)
#define TT_ELSE                         ((knh_token_t)15)
#define TT_SWITCH                       ((knh_token_t)16)
#define TT_CASE                         ((knh_token_t)17)
#define TT_WHILE                        ((knh_token_t)18)
#define TT_DO                           ((knh_token_t)19)
#define TT_FOR                          ((knh_token_t)20)
#define TT_FOREACH                      ((knh_token_t)21)
#define TT_BREAK                        ((knh_token_t)22)
#define TT_CONTINUE                     ((knh_token_t)23)
#define TT_TRY                          ((knh_token_t)24)
#define TT_CATCH                        ((knh_token_t)25)
#define TT_FINALLY                      ((knh_token_t)26)
#define TT_THROW                        ((knh_token_t)27)
#define TT_TEST                         ((knh_token_t)28)
#define TT_REGISTER                     ((knh_token_t)29)
#define TT_PRINT                        ((knh_token_t)30)
#define TT_ASSERT                       ((knh_token_t)31)
#define TT_BRACE                        ((knh_token_t)32)
#define TT_PARENTHESIS                  ((knh_token_t)33)
#define TT_BRANCET                      ((knh_token_t)34)
#define TT_DOTS                         ((knh_token_t)35)
#define TT_SEMICOLON                    ((knh_token_t)36)
#define TT_COMMA                        ((knh_token_t)37)
#define TT_FUNCMAP                      ((knh_token_t)38)
#define TT_IT                           ((knh_token_t)39)
#define TT_LET                          ((knh_token_t)40)
#define TT_LSHIFTE                      ((knh_token_t)41)
#define TT_RSHIFTE                      ((knh_token_t)42)
#define TT_ADDE                         ((knh_token_t)43)
#define TT_SUBE                         ((knh_token_t)44)
#define TT_DIVE                         ((knh_token_t)45)
#define TT_MODE                         ((knh_token_t)46)
#define TT_MULE                         ((knh_token_t)47)
#define TT_BITANDE                      ((knh_token_t)48)
#define TT_BITORE                       ((knh_token_t)49)
#define TT_ALTLET                       ((knh_token_t)50)
#define TT_QUESTION                     ((knh_token_t)51)
#define TT_COLON                        ((knh_token_t)52)
#define TT_ITR                          ((knh_token_t)53)
#define TT_ALT                          ((knh_token_t)54)
#define TT_OR                           ((knh_token_t)55)
#define TT_AND                          ((knh_token_t)56)
#define TT_NOT                          ((knh_token_t)57)
#define TT_INSTANCEOF                   ((knh_token_t)58)
#define TT_AS                           ((knh_token_t)59)
#define TT_HAS                          ((knh_token_t)60)
#define TT_INTO                         ((knh_token_t)61)
#define TT_IS                           ((knh_token_t)62)
#define TT_SAME                         ((knh_token_t)63)
#define TT_EQ                           ((knh_token_t)64)
#define TT_NEQ                          ((knh_token_t)65)
#define TT_LT                           ((knh_token_t)66)
#define TT_LTE                          ((knh_token_t)67)
#define TT_GT                           ((knh_token_t)68)
#define TT_GTE                          ((knh_token_t)69)
#define TT_MATCH                        ((knh_token_t)70)
#define TT_FROM                         ((knh_token_t)71)
#define TT_WHERE                        ((knh_token_t)72)
#define TT_TO                           ((knh_token_t)73)
#define TT_UNTIL                        ((knh_token_t)74)
...
#define STT_UCLASS                      ((knh_stmt_t)5)
...
#define STT_MAPMAP                      ((knh_stmt_t)16)
#define STT_METHOD                      ((knh_stmt_t)17)
#define STT_FUNCTION                    ((knh_stmt_t)18)
#define STT_FORMAT                      ((knh_stmt_t)19)
#define STT_DECL                        ((knh_stmt_t)20)
#define STT_RETURN                      ((knh_stmt_t)21)
...
#define STT_BREAK                       ((knh_stmt_t)33)
#define STT_CONTINUE                    ((knh_stmt_t)34)
#define STT_TRY                         ((knh_stmt_t)35)
#define STT_CATCH                       ((knh_stmt_t)36)
#define STT_FINALLY                     ((knh_stmt_t)37)
#define STT_THROW                       ((knh_stmt_t)38)
#define STT_TEST                        ((knh_stmt_t)39)
#define STT_ERR                         ((knh_stmt_t)40)
#define STT_LET                         ((knh_stmt_t)41)
#define STT_LETM                        ((knh_stmt_t)42)
#define STT_REGISTER                    ((knh_stmt_t)43)
#define STT_SEPARATOR                   ((knh_stmt_t)44)
