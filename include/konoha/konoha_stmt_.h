...
#define TT_REGISTER                     ((knh_token_t)28)
#define TT_PRINT                        ((knh_token_t)29)
#define TT_ASSERT                       ((knh_token_t)30)
#define TT_BRACE                        ((knh_token_t)31)
#define TT_PARENTHESIS                  ((knh_token_t)32)
#define TT_BRANCET                      ((knh_token_t)33)
#define TT_DOTS                         ((knh_token_t)34)
#define TT_SEMICOLON                    ((knh_token_t)35)
#define TT_COMMA                        ((knh_token_t)36)
#define TT_FUNCMAP                      ((knh_token_t)37)
#define TT_TEST                         ((knh_token_t)38)
...
/* ======================================================================== */
/* [utest] */
#define StmtUTEST_test(stmt)            DP(stmt)->terms[0]
#define UTEST_test                      0
#define StmtUTEST_spec(stmt)            DP(stmt)->terms[1]
#define UTEST_spec                      1
