...
/* ======================================================================== */
/* MACROS */
#define K_REVISION                      1718
#define K_BUILDID                       956
...
#define FN_end          (MN_OPSIZE+31)
#define FN_endsWith     (MN_OPSIZE+32)
#define FN_endswith     (MN_OPSIZE+32)
#define FN_equals       (MN_OPSIZE+33)
#define FN_err          (MN_OPSIZE+34)
#define FN_exec         (MN_OPSIZE+35)
#define FN_exit         (MN_OPSIZE+36)
#define FN_f            (MN_OPSIZE+37)
#define FN_flag         (MN_OPSIZE+38)
#define FN_float        (MN_OPSIZE+39)
#define FN_floatToIntBits (MN_OPSIZE+40)
#define FN_floattointbits (MN_OPSIZE+40)
#define FN_flush        (MN_OPSIZE+41)
#define FN_fmt          (MN_OPSIZE+42)
#define FN_format       (MN_OPSIZE+43)
#define FN_gc           (MN_OPSIZE+44)
#define FN_hashCode     (MN_OPSIZE+45)
#define FN_hashcode     (MN_OPSIZE+45)
#define FN_in           (MN_OPSIZE+46)
#define FN_indexOf      (MN_OPSIZE+47)
#define FN_indexof      (MN_OPSIZE+47)
#define FN_init         (MN_OPSIZE+48)
#define FN_initCapacity (MN_OPSIZE+49)
#define FN_initcapacity (MN_OPSIZE+49)
#define FN_int          (MN_OPSIZE+50)
#define FN_intToFloatBits (MN_OPSIZE+51)
#define FN_inttofloatbits (MN_OPSIZE+51)
#define FN_invoke       (MN_OPSIZE+52)
#define FN_it           (MN_OPSIZE+53)
#define FN_k            (MN_OPSIZE+54)
#define FN_key          (MN_OPSIZE+55)
#define FN_lastIndexOf  (MN_OPSIZE+56)
#define FN_lastindexof  (MN_OPSIZE+56)
#define FN_length       (MN_OPSIZE+57)
#define FN_likely       (MN_OPSIZE+58)
#define FN_listProperties (MN_OPSIZE+59)
#define FN_listproperties (MN_OPSIZE+59)
#define FN_main         (MN_OPSIZE+60)
#define FN_man          (MN_OPSIZE+61)
#define FN_method       (MN_OPSIZE+62)
#define FN_mode         (MN_OPSIZE+63)
#define FN_msg          (MN_OPSIZE+64)
#define FN_n            (MN_OPSIZE+65)
#define FN_name         (MN_OPSIZE+66)
#define FN_new          (MN_OPSIZE+67)
#define FN_new__ARRAY   (MN_OPSIZE+68)
#define FN_new__array   (MN_OPSIZE+68)
#define FN_new__LIST    (MN_OPSIZE+69)
#define FN_new__list    (MN_OPSIZE+69)
#define FN_new__MAP     (MN_OPSIZE+70)
#define FN_new__map     (MN_OPSIZE+70)
#define FN_new__RANGE   (MN_OPSIZE+71)
#define FN_new__range   (MN_OPSIZE+71)
#define FN_new__TUPLE   (MN_OPSIZE+72)
#define FN_new__tuple   (MN_OPSIZE+72)
#define FN_next         (MN_OPSIZE+73)
#define FN_notNull      (MN_OPSIZE+74)
#define FN_notnull      (MN_OPSIZE+74)
#define FN_ns           (MN_OPSIZE+75)
#define FN_null         (MN_OPSIZE+76)
#define FN_offset       (MN_OPSIZE+77)
#define FN_option       (MN_OPSIZE+78)
#define FN_out          (MN_OPSIZE+79)
#define FN_p            (MN_OPSIZE+80)
#define FN_path         (MN_OPSIZE+81)
#define FN_pattern      (MN_OPSIZE+82)
#define FN_print        (MN_OPSIZE+83)
#define FN_println      (MN_OPSIZE+84)
#define FN_property     (MN_OPSIZE+85)
#define FN_push         (MN_OPSIZE+86)
#define FN_putc         (MN_OPSIZE+87)
#define FN_qualifier    (MN_OPSIZE+88)
#define FN_query        (MN_OPSIZE+89)
#define FN_random       (MN_OPSIZE+90)
#define FN_randomSeed   (MN_OPSIZE+91)
#define FN_randomseed   (MN_OPSIZE+91)
#define FN_re           (MN_OPSIZE+92)
#define FN_read         (MN_OPSIZE+93)
#define FN_readLine     (MN_OPSIZE+94)
#define FN_readline     (MN_OPSIZE+94)
#define FN_remove       (MN_OPSIZE+95)
#define FN_replace      (MN_OPSIZE+96)
#define FN_s            (MN_OPSIZE+97)
#define FN_seed         (MN_OPSIZE+98)
#define FN_size         (MN_OPSIZE+99)
#define FN_split        (MN_OPSIZE+100)
#define FN_start        (MN_OPSIZE+101)
#define FN_startsWith   (MN_OPSIZE+102)
#define FN_startswith   (MN_OPSIZE+102)
#define FN_status       (MN_OPSIZE+103)
#define FN_string       (MN_OPSIZE+104)
#define FN_substring    (MN_OPSIZE+105)
#define FN_super        (MN_OPSIZE+106)
#define FN_this         (MN_OPSIZE+107)
#define FN_time         (MN_OPSIZE+108)
#define FN_trim         (MN_OPSIZE+109)
#define FN_u            (MN_OPSIZE+110)
#define FN_unlikely     (MN_OPSIZE+111)
#define FN_urn          (MN_OPSIZE+112)
#define FN_v            (MN_OPSIZE+113)
#define FN_value        (MN_OPSIZE+114)
#define FN_vargs        (MN_OPSIZE+115)
#define FN_verbose      (MN_OPSIZE+116)
#define FN_write        (MN_OPSIZE+117)
#define FN_writeChar    (MN_OPSIZE+118)
#define FN_writechar    (MN_OPSIZE+118)
#define FN_writeData    (MN_OPSIZE+119)
#define FN_writedata    (MN_OPSIZE+119)
#define FN_x            (MN_OPSIZE+120)
#define K_TFIELD_SIZE   121
