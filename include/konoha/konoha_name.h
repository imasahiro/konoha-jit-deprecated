...
#define FN_startswith   (MN_OPSIZE+98)
#define FN_status       (MN_OPSIZE+99)
#define FN_string       (MN_OPSIZE+100)
#define FN_substring    (MN_OPSIZE+101)
#define FN_super        (MN_OPSIZE+102)
#define FN_this         (MN_OPSIZE+103)
#define FN_time         (MN_OPSIZE+104)
#define FN_trim         (MN_OPSIZE+105)
#define FN_u            (MN_OPSIZE+106)
#define FN_unlikely     (MN_OPSIZE+107)
#define FN_urn          (MN_OPSIZE+108)
#define FN_v            (MN_OPSIZE+109)
#define FN_value        (MN_OPSIZE+110)
#define FN_vargs        (MN_OPSIZE+111)
#define FN_verbose      (MN_OPSIZE+112)
#define FN_write        (MN_OPSIZE+113)
#define FN_writeChar    (MN_OPSIZE+114)
#define FN_writechar    (MN_OPSIZE+114)
#define FN_writeData    (MN_OPSIZE+115)
#define FN_writedata    (MN_OPSIZE+115)
#define FN_x            (MN_OPSIZE+116)
#define K_TFIELD_SIZE   117
