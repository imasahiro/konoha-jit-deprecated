...
/* ======================================================================== */
/* MACROS */
#define K_REVISION                      1810
#define K_BUILDID                       971
...
#define FN_k            (MN_OPSIZE+51)
#define FN_key          (MN_OPSIZE+52)
#define FN_lastIndexOf  (MN_OPSIZE+53)
#define FN_lastindexof  (MN_OPSIZE+53)
#define FN_length       (MN_OPSIZE+54)
#define FN_likely       (MN_OPSIZE+55)
#define FN_listProperties (MN_OPSIZE+56)
#define FN_listproperties (MN_OPSIZE+56)
#define FN_main         (MN_OPSIZE+57)
#define FN_man          (MN_OPSIZE+58)
#define FN_match        (MN_OPSIZE+59)
#define FN_method       (MN_OPSIZE+60)
#define FN_mode         (MN_OPSIZE+61)
#define FN_msg          (MN_OPSIZE+62)
#define FN_n            (MN_OPSIZE+63)
#define FN_name         (MN_OPSIZE+64)
#define FN_new          (MN_OPSIZE+65)
#define FN_new__ARRAY   (MN_OPSIZE+66)
#define FN_new__array   (MN_OPSIZE+66)
#define FN_new__LIST    (MN_OPSIZE+67)
#define FN_new__list    (MN_OPSIZE+67)
#define FN_new__MAP     (MN_OPSIZE+68)
#define FN_new__map     (MN_OPSIZE+68)
#define FN_next         (MN_OPSIZE+69)
#define FN_notNull      (MN_OPSIZE+70)
#define FN_notnull      (MN_OPSIZE+70)
#define FN_ns           (MN_OPSIZE+71)
#define FN_null         (MN_OPSIZE+72)
#define FN_offset       (MN_OPSIZE+73)
#define FN_option       (MN_OPSIZE+74)
#define FN_out          (MN_OPSIZE+75)
#define FN_p            (MN_OPSIZE+76)
#define FN_path         (MN_OPSIZE+77)
#define FN_pattern      (MN_OPSIZE+78)
#define FN_print        (MN_OPSIZE+79)
#define FN_println      (MN_OPSIZE+80)
#define FN_property     (MN_OPSIZE+81)
#define FN_putc         (MN_OPSIZE+82)
#define FN_qualifier    (MN_OPSIZE+83)
#define FN_query        (MN_OPSIZE+84)
#define FN_random       (MN_OPSIZE+85)
#define FN_randomSeed   (MN_OPSIZE+86)
#define FN_randomseed   (MN_OPSIZE+86)
#define FN_re           (MN_OPSIZE+87)
#define FN_read         (MN_OPSIZE+88)
#define FN_readLine     (MN_OPSIZE+89)
#define FN_readline     (MN_OPSIZE+89)
#define FN_remove       (MN_OPSIZE+90)
#define FN_replace      (MN_OPSIZE+91)
#define FN_s            (MN_OPSIZE+92)
#define FN_search       (MN_OPSIZE+93)
#define FN_seed         (MN_OPSIZE+94)
#define FN_size         (MN_OPSIZE+95)
#define FN_split        (MN_OPSIZE+96)
#define FN_startsWith   (MN_OPSIZE+97)
#define FN_startswith   (MN_OPSIZE+97)
#define FN_string       (MN_OPSIZE+98)
#define FN_substring    (MN_OPSIZE+99)
#define FN_super        (MN_OPSIZE+100)
#define FN_this         (MN_OPSIZE+101)
#define FN_time         (MN_OPSIZE+102)
#define FN_trim         (MN_OPSIZE+103)
#define FN_u            (MN_OPSIZE+104)
#define FN_unlikely     (MN_OPSIZE+105)
#define FN_urn          (MN_OPSIZE+106)
#define FN_v            (MN_OPSIZE+107)
#define FN_value        (MN_OPSIZE+108)
#define FN_vargs        (MN_OPSIZE+109)
#define FN_verbose      (MN_OPSIZE+110)
#define FN_write        (MN_OPSIZE+111)
#define FN_writeChar    (MN_OPSIZE+112)
#define FN_writechar    (MN_OPSIZE+112)
#define FN_writeData    (MN_OPSIZE+113)
#define FN_writedata    (MN_OPSIZE+113)
#define FN_x            (MN_OPSIZE+114)
#define K_TFIELD_SIZE   115
