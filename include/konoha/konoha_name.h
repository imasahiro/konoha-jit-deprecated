...
/* ======================================================================== */
/* MACROS */
#define KONOHA_REVISION                 1048
#define KONOHA_BUILDID                  773
...
#define STRUCT_Thunk            ((knh_struct_t)26)
...
#define STRUCT_Semantics        ((knh_struct_t)30)
...
/* ------------------------------------------------------------------------ */
/* Thread */
#define CLASS_Thread            ((knh_class_t)42)
#define STRUCT_Thread           ((knh_struct_t)42)
...
/* ------------------------------------------------------------------------ */
/* ScriptEngine */
#define CLASS_ScriptEngine      ((knh_class_t)43)
#define STRUCT_ScriptEngine     ((knh_struct_t)43)
...
/* ------------------------------------------------------------------------ */
/* Token */
#define CLASS_Token             ((knh_class_t)44)
#define STRUCT_Token            ((knh_struct_t)44)
...
/* ------------------------------------------------------------------------ */
/* Stmt */
#define CLASS_Stmt              ((knh_class_t)45)
#define STRUCT_Stmt             ((knh_struct_t)45)
...
/* ------------------------------------------------------------------------ */
/* Gamma */
#define CLASS_Gamma             ((knh_class_t)46)
#define STRUCT_Gamma            ((knh_struct_t)46)
...
/* ------------------------------------------------------------------------ */
/* KLRInst */
#define CLASS_KLRInst           ((knh_class_t)47)
#define STRUCT_KLRInst          ((knh_struct_t)47)
...
/* ------------------------------------------------------------------------ */
/* KLRCode */
#define CLASS_KLRCode           ((knh_class_t)48)
#define STRUCT_KLRCode          ((knh_struct_t)48)
...
/* ------------------------------------------------------------------------ */
/* This */
#define CLASS_This              ((knh_class_t)49)
...
/* ------------------------------------------------------------------------ */
/* Tvoid */
#define CLASS_Tvoid             ((knh_class_t)50)
...
/* ------------------------------------------------------------------------ */
/* T0 */
#define CLASS_T0                ((knh_class_t)51)
...
/* ------------------------------------------------------------------------ */
/* T1 */
#define CLASS_T1                ((knh_class_t)52)
...
/* ------------------------------------------------------------------------ */
/* T2 */
#define CLASS_T2                ((knh_class_t)53)
...
/* ------------------------------------------------------------------------ */
/* T3 */
#define CLASS_T3                ((knh_class_t)54)
...
/* ------------------------------------------------------------------------ */
/* Tx */
#define CLASS_Tx                ((knh_class_t)55)
...
/* ------------------------------------------------------------------------ */
/* Tvar */
#define CLASS_Tvar              ((knh_class_t)56)
...
/* ------------------------------------------------------------------------ */
/* PairSS */
#define CLASS_PairSS            ((knh_class_t)57)
...
/* ------------------------------------------------------------------------ */
/* PairST1 */
#define CLASS_PairST1           ((knh_class_t)58)
...
/* ------------------------------------------------------------------------ */
/* PairT1T2 */
#define CLASS_PairT1T2          ((knh_class_t)59)
...
/* ------------------------------------------------------------------------ */
/* Cmpr */
#define CLASS_Cmpr              ((knh_class_t)60)
...
/* ------------------------------------------------------------------------ */
/* String_Ary */
#define CLASS_String_Ary        ((knh_class_t)61)
...
/* ------------------------------------------------------------------------ */
/* Any_Ary */
#define CLASS_Any_Ary           ((knh_class_t)62)
...
/* ------------------------------------------------------------------------ */
/* String_Itr */
#define CLASS_String_Itr        ((knh_class_t)63)
...
/* ------------------------------------------------------------------------ */
/* T1_Itr */
#define CLASS_T1_Itr            ((knh_class_t)64)
...
/* ------------------------------------------------------------------------ */
/* PairST1_Itr */
#define CLASS_PairST1_Itr       ((knh_class_t)65)
...
/* ------------------------------------------------------------------------ */
/* PairT1T2_Itr */
#define CLASS_PairT1T2_Itr      ((knh_class_t)66)
...
/* ------------------------------------------------------------------------ */
/* This_Itr */
#define CLASS_This_Itr          ((knh_class_t)67)
...
/* ------------------------------------------------------------------------ */
/* Thrd */
#define CLASS_Thrd              ((knh_class_t)68)
#define STRUCT_Thrd             STRUCT_Closure
#define IS_Thrd(o)              ((o)->h.cid == CLASS_Thrd)
#define TYPE_Thrd               CLASS_Thrd
#define NNTYPE_Thrd             NNTYPE_cid(CLASS_Thrd)
#define NATYPE_Thrd             NATYPE_cid(CLASS_Thrd)
#define CFLAG_Thrd              ((knh_flag_t)0)
#define FLAG_Thrd               knh_flag_oflag(CFLAG_Thrd)
...
#define FIELDN_args     8
#define FIELDN_ascii    9
#define FIELDN_autoFlush 10
#define FIELDN_autoflush 10
#define FIELDN_bag      11
#define FIELDN_base     12
#define FIELDN_bits     13
#define FIELDN_buf      14
#define FIELDN_bytes    15
#define FIELDN_c        16
#define FIELDN_cc       17
#define FIELDN_ch       18
#define FIELDN_char     19
#define FIELDN_class    20
#define FIELDN_clear    21
#define FIELDN_clearBuffer 22
#define FIELDN_clearbuffer 22
#define FIELDN_close    23
#define FIELDN_closed   24
#define FIELDN_cmd      25
#define FIELDN_concat   26
#define FIELDN_const    27
#define FIELDN_d        28
#define FIELDN_data     29
#define FIELDN_debug    30
#define FIELDN_default  31
#define FIELDN_defined  32
#define FIELDN_delegate 33
#define FIELDN_delim    34
#define FIELDN_derived  35
#define FIELDN_domain   36
#define FIELDN_dump     37
#define FIELDN_e        38
#define FIELDN_empty    39
#define FIELDN_enc      40
#define FIELDN_encoding 41
#define FIELDN_end      42
#define FIELDN_endsWith 43
#define FIELDN_endswith 43
#define FIELDN_endsWith__IgnoreCase 44
#define FIELDN_endswith__ignorecase 44
#define FIELDN_equals   45
#define FIELDN_equals__IgnoreCase 46
#define FIELDN_equals__ignorecase 46
#define FIELDN_err      47
#define FIELDN_eval     48
#define FIELDN_exec     49
#define FIELDN_exit     50
#define FIELDN_f        51
#define FIELDN_final    52
#define FIELDN_first    53
#define FIELDN_flag     54
#define FIELDN_float    55
#define FIELDN_floatToIntBits 56
#define FIELDN_floattointbits 56
#define FIELDN_flush    57
#define FIELDN_fmt      58
#define FIELDN_format   59
#define FIELDN_func     60
#define FIELDN_gc       61
#define FIELDN_hasDir   62
#define FIELDN_hasdir   62
#define FIELDN_hasFile  63
#define FIELDN_hasfile  63
#define FIELDN_hashCode 64
#define FIELDN_hashcode 64
#define FIELDN_hasLib   65
#define FIELDN_haslib   65
#define FIELDN_host     66
#define FIELDN_iCast    67
#define FIELDN_icast    67
#define FIELDN_ignoreCase 68
#define FIELDN_ignorecase 68
#define FIELDN_immutable 69
#define FIELDN_in       70
#define FIELDN_indexOf  71
#define FIELDN_indexof  71
#define FIELDN_indexOf__IgnoreCase 72
#define FIELDN_indexof__ignorecase 72
#define FIELDN_init     73
#define FIELDN_initCapacity 74
#define FIELDN_initcapacity 74
#define FIELDN_inputStream 75
#define FIELDN_inputstream 75
#define FIELDN_insert   76
#define FIELDN_int      77
#define FIELDN_interactive 78
#define FIELDN_interface 79
#define FIELDN_intToFloatBits 80
#define FIELDN_inttofloatbits 80
#define FIELDN_invoke   81
#define FIELDN_isInclusive 82
#define FIELDN_isinclusive 82
#define FIELDN_isTrim   83
#define FIELDN_istrim   83
#define FIELDN_k        84
#define FIELDN_key      85
#define FIELDN_keys     86
#define FIELDN_lastIndexOf 87
#define FIELDN_lastindexof 87
#define FIELDN_lastIndexOf__IgnoreCase 88
#define FIELDN_lastindexof__ignorecase 88
#define FIELDN_length   89
#define FIELDN_lib      90
#define FIELDN_likely   91
#define FIELDN_line     92
#define FIELDN_listDir  93
#define FIELDN_listdir  93
#define FIELDN_listProperties 94
#define FIELDN_listproperties 94
#define FIELDN_local    95
#define FIELDN_logging  96
#define FIELDN_lossLess 97
#define FIELDN_lossless 97
#define FIELDN_m        98
#define FIELDN_main     99
#define FIELDN_man      100
#define FIELDN_match    101
#define FIELDN_memcpy   102
#define FIELDN_metaClass 103
#define FIELDN_metaclass 103
#define FIELDN_method   104
#define FIELDN_methodCompilationListener 105
#define FIELDN_methodcompilationlistener 105
#define FIELDN_methodTypingListener 106
#define FIELDN_methodtypinglistener 106
#define FIELDN_mkdir    107
#define FIELDN_mode     108
#define FIELDN_modified 109
#define FIELDN_msg      110
#define FIELDN_n        111
#define FIELDN_name     112
#define FIELDN_new      113
#define FIELDN_new__array 114
#define FIELDN_new__array 114
#define FIELDN_new__array2D 115
#define FIELDN_new__array2d 115
#define FIELDN_new__array3D 116
#define FIELDN_new__array3d 116
#define FIELDN_new__dictmap 117
#define FIELDN_new__dictmap 117
#define FIELDN_new__init 118
#define FIELDN_new__init 118
#define FIELDN_new__range 119
#define FIELDN_new__range 119
#define FIELDN_newone   120
#define FIELDN_newpath  121
#define FIELDN_next     122
#define FIELDN_notNull  123
#define FIELDN_notnull  123
#define FIELDN_null     124
#define FIELDN_o        125
#define FIELDN_offset   126
#define FIELDN_op0      127
#define FIELDN_op1      128
#define FIELDN_opAdd    129
#define FIELDN_opadd    129
#define FIELDN_opAddr   130
#define FIELDN_opaddr   130
#define FIELDN_opAppend 131
#define FIELDN_opappend 131
#define FIELDN_opAs     132
#define FIELDN_opas     132
#define FIELDN_opCase   133
#define FIELDN_opcase   133
#define FIELDN_opDiv    134
#define FIELDN_opdiv    134
#define FIELDN_opEq     135
#define FIELDN_opeq     135
#define FIELDN_opGt     136
#define FIELDN_opgt     136
#define FIELDN_opGte    137
#define FIELDN_opgte    137
#define FIELDN_opHas    138
#define FIELDN_ophas    138
#define FIELDN_opInstanceof 139
#define FIELDN_opinstanceof 139
#define FIELDN_opInTo   140
#define FIELDN_opinto   140
#define FIELDN_opIs     141
#define FIELDN_opis     141
#define FIELDN_opItr    142
#define FIELDN_opitr    142
#define FIELDN_opItr__2 143
#define FIELDN_opitr__2 143
#define FIELDN_opLand   144
#define FIELDN_opland   144
#define FIELDN_opLnot   145
#define FIELDN_oplnot   145
#define FIELDN_opLor    146
#define FIELDN_oplor    146
#define FIELDN_opLshift 147
#define FIELDN_oplshift 147
#define FIELDN_opLt     148
#define FIELDN_oplt     148
#define FIELDN_opLte    149
#define FIELDN_oplte    149
#define FIELDN_opMatch  150
#define FIELDN_opmatch  150
#define FIELDN_opMod    151
#define FIELDN_opmod    151
#define FIELDN_opMul    152
#define FIELDN_opmul    152
#define FIELDN_opN      153
#define FIELDN_opn      153
#define FIELDN_opNeg    154
#define FIELDN_opneg    154
#define FIELDN_opNeq    155
#define FIELDN_opneq    155
#define FIELDN_opNext   156
#define FIELDN_opnext   156
#define FIELDN_opNot    157
#define FIELDN_opnot    157
#define FIELDN_opPrev   158
#define FIELDN_opprev   158
#define FIELDN_opRangeTo 159
#define FIELDN_oprangeto 159
#define FIELDN_opRangeUntil 160
#define FIELDN_oprangeuntil 160
#define FIELDN_opRshift 161
#define FIELDN_oprshift 161
#define FIELDN_opSub    162
#define FIELDN_opsub    162
#define FIELDN_option   163
#define FIELDN_opXor    164
#define FIELDN_opxor    164
#define FIELDN_out      165
#define FIELDN_outputStream 166
#define FIELDN_outputstream 166
#define FIELDN_p        167
#define FIELDN_partial  168
#define FIELDN_path     169
#define FIELDN_pattern  170
#define FIELDN_pop      171
#define FIELDN_port     172
#define FIELDN_print    173
#define FIELDN_println  174
#define FIELDN_private  175
#define FIELDN_profCount 176
#define FIELDN_profcount 176
#define FIELDN_profTime 177
#define FIELDN_proftime 177
#define FIELDN_prompt   178
#define FIELDN_property 179
#define FIELDN_public   180
#define FIELDN_putc     181
#define FIELDN_putChar  182
#define FIELDN_putchar  182
#define FIELDN_query    183
#define FIELDN_random   184
#define FIELDN_randomSeed 185
#define FIELDN_randomseed 185
#define FIELDN_re       186
#define FIELDN_read     187
#define FIELDN_readData 188
#define FIELDN_readdata 188
#define FIELDN_readLine 189
#define FIELDN_readline 189
#define FIELDN_release  190
#define FIELDN_remove   191
#define FIELDN_rename   192
#define FIELDN_replace  193
#define FIELDN_result   194
#define FIELDN_reverse  195
#define FIELDN_s        196
#define FIELDN_script   197
#define FIELDN_second   198
#define FIELDN_seed     199
#define FIELDN_shared   200
#define FIELDN_shuffle  201
#define FIELDN_significant 202
#define FIELDN_singleton 203
#define FIELDN_size     204
#define FIELDN_sort     205
#define FIELDN_sortByClosure 206
#define FIELDN_sortbyclosure 206
#define FIELDN_split    207
#define FIELDN_start    208
#define FIELDN_startsWith 209
#define FIELDN_startswith 209
#define FIELDN_startsWith__IgnoreCase 210
#define FIELDN_startswith__ignorecase 210
#define FIELDN_static   211
#define FIELDN_status   212
#define FIELDN_stmt     213
#define FIELDN_storingBuffer 214
#define FIELDN_storingbuffer 214
#define FIELDN_strict   215
#define FIELDN_string   216
#define FIELDN_substring 217
#define FIELDN_super    218
#define FIELDN_swap     219
#define FIELDN_synonym  220
#define FIELDN_system   221
#define FIELDN_temporal 222
#define FIELDN_test     223
#define FIELDN_this     224
#define FIELDN_tickCount 225
#define FIELDN_tickcount 225
#define FIELDN_times    226
#define FIELDN_toLower  227
#define FIELDN_tolower  227
#define FIELDN_total    228
#define FIELDN_toUpper  229
#define FIELDN_toupper  229
#define FIELDN_trace    230
#define FIELDN_trim     231
#define FIELDN_twofold  232
#define FIELDN_typeof   233
#define FIELDN_u        234
#define FIELDN_uCS4     235
#define FIELDN_ucs4     235
#define FIELDN_undefined 236
#define FIELDN_unique   237
#define FIELDN_unlikely 238
#define FIELDN_unlink   239
#define FIELDN_urn      240
#define FIELDN_v        241
#define FIELDN_value    242
#define FIELDN_values   243
#define FIELDN_varArgs  244
#define FIELDN_varargs  244
#define FIELDN_vargs    245
#define FIELDN_verbose  246
#define FIELDN_virtual  247
#define FIELDN_w        248
#define FIELDN_write    249
#define FIELDN_writeData 250
#define FIELDN_writedata 250
#define FIELDN_x        251
#define FIELDN_y        252
#define FIELDN_z        253
#define KNH_TFIELDN_SIZE 254
...
#define METHODN_sortByClosure FIELDN_sortbyclosure
...
#define METHODN_values  FIELDN_values
