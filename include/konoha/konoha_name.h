...
/* ======================================================================== */
/* MACROS */
#define K_REVISION                      1751
#define K_BUILDID                       964
...
#define FN_invoke       (MN_OPSIZE+50)
#define FN_it           (MN_OPSIZE+51)
...
#define FN_push         (MN_OPSIZE+83)
#define FN_putc         (MN_OPSIZE+84)
#define FN_qualifier    (MN_OPSIZE+85)
#define FN_query        (MN_OPSIZE+86)
#define FN_random       (MN_OPSIZE+87)
#define FN_randomSeed   (MN_OPSIZE+88)
#define FN_randomseed   (MN_OPSIZE+88)
#define FN_re           (MN_OPSIZE+89)
#define FN_read         (MN_OPSIZE+90)
#define FN_readLine     (MN_OPSIZE+91)
#define FN_readline     (MN_OPSIZE+91)
#define FN_remove       (MN_OPSIZE+92)
#define FN_replace      (MN_OPSIZE+93)
#define FN_s            (MN_OPSIZE+94)
#define FN_search       (MN_OPSIZE+95)
#define FN_seed         (MN_OPSIZE+96)
#define FN_size         (MN_OPSIZE+97)
#define FN_split        (MN_OPSIZE+98)
#define FN_startsWith   (MN_OPSIZE+99)
#define FN_startswith   (MN_OPSIZE+99)
#define FN_status       (MN_OPSIZE+100)
#define FN_string       (MN_OPSIZE+101)
#define FN_substring    (MN_OPSIZE+102)
#define FN_super        (MN_OPSIZE+103)
#define FN_this         (MN_OPSIZE+104)
#define FN_time         (MN_OPSIZE+105)
#define FN_trim         (MN_OPSIZE+106)
#define FN_u            (MN_OPSIZE+107)
#define FN_unlikely     (MN_OPSIZE+108)
#define FN_urn          (MN_OPSIZE+109)
#define FN_v            (MN_OPSIZE+110)
#define FN_value        (MN_OPSIZE+111)
#define FN_vargs        (MN_OPSIZE+112)
#define FN_verbose      (MN_OPSIZE+113)
#define FN_write        (MN_OPSIZE+114)
#define FN_writeChar    (MN_OPSIZE+115)
#define FN_writechar    (MN_OPSIZE+115)
#define FN_writeData    (MN_OPSIZE+116)
#define FN_writedata    (MN_OPSIZE+116)
#define FN_x            (MN_OPSIZE+117)
#define K_TFIELD_SIZE   118
