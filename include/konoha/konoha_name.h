...
#define FN_final        (MN_OPSIZE+38)
#define FN_flag         (MN_OPSIZE+39)
#define FN_float        (MN_OPSIZE+40)
#define FN_floatToIntBits (MN_OPSIZE+41)
#define FN_floattointbits (MN_OPSIZE+41)
#define FN_flush        (MN_OPSIZE+42)
#define FN_fmt          (MN_OPSIZE+43)
#define FN_format       (MN_OPSIZE+44)
#define FN_gc           (MN_OPSIZE+45)
#define FN_hashCode     (MN_OPSIZE+46)
#define FN_hashcode     (MN_OPSIZE+46)
#define FN_immutable    (MN_OPSIZE+47)
#define FN_in           (MN_OPSIZE+48)
#define FN_indexOf      (MN_OPSIZE+49)
#define FN_indexof      (MN_OPSIZE+49)
#define FN_init         (MN_OPSIZE+50)
#define FN_initCapacity (MN_OPSIZE+51)
#define FN_initcapacity (MN_OPSIZE+51)
#define FN_int          (MN_OPSIZE+52)
#define FN_interactive  (MN_OPSIZE+53)
#define FN_interface    (MN_OPSIZE+54)
#define FN_intToFloatBits (MN_OPSIZE+55)
#define FN_inttofloatbits (MN_OPSIZE+55)
#define FN_invoke       (MN_OPSIZE+56)
...
#define FN_likely       (MN_OPSIZE+62)
#define FN_listProperties (MN_OPSIZE+63)
#define FN_listproperties (MN_OPSIZE+63)
#define FN_logging      (MN_OPSIZE+64)
#define FN_lossLess     (MN_OPSIZE+65)
#define FN_lossless     (MN_OPSIZE+65)
#define FN_main         (MN_OPSIZE+66)
#define FN_man          (MN_OPSIZE+67)
#define FN_metaClass    (MN_OPSIZE+68)
#define FN_metaclass    (MN_OPSIZE+68)
#define FN_method       (MN_OPSIZE+69)
#define FN_mode         (MN_OPSIZE+70)
#define FN_modified     (MN_OPSIZE+71)
...
#define FN_new__map     (MN_OPSIZE+78)
#define FN_new__RANGE   (MN_OPSIZE+79)
#define FN_new__range   (MN_OPSIZE+79)
...
#define FN_readline     (MN_OPSIZE+105)
#define FN_release      (MN_OPSIZE+106)
#define FN_remove       (MN_OPSIZE+107)
#define FN_replace      (MN_OPSIZE+108)
#define FN_s            (MN_OPSIZE+109)
#define FN_seed         (MN_OPSIZE+110)
#define FN_semantic     (MN_OPSIZE+111)
#define FN_shared       (MN_OPSIZE+112)
#define FN_significant  (MN_OPSIZE+113)
#define FN_singleton    (MN_OPSIZE+114)
#define FN_size         (MN_OPSIZE+115)
#define FN_split        (MN_OPSIZE+116)
#define FN_start        (MN_OPSIZE+117)
#define FN_startsWith   (MN_OPSIZE+118)
#define FN_startswith   (MN_OPSIZE+118)
#define FN_static       (MN_OPSIZE+119)
#define FN_status       (MN_OPSIZE+120)
#define FN_storingBuffer (MN_OPSIZE+121)
#define FN_storingbuffer (MN_OPSIZE+121)
#define FN_strict       (MN_OPSIZE+122)
#define FN_string       (MN_OPSIZE+123)
#define FN_substring    (MN_OPSIZE+124)
#define FN_super        (MN_OPSIZE+125)
#define FN_temporal     (MN_OPSIZE+126)
#define FN_this         (MN_OPSIZE+127)
#define FN_time         (MN_OPSIZE+128)
#define FN_total        (MN_OPSIZE+129)
#define FN_trim         (MN_OPSIZE+130)
#define FN_u            (MN_OPSIZE+131)
#define FN_unique       (MN_OPSIZE+132)
#define FN_unlikely     (MN_OPSIZE+133)
#define FN_urn          (MN_OPSIZE+134)
#define FN_v            (MN_OPSIZE+135)
#define FN_value        (MN_OPSIZE+136)
#define FN_vargs        (MN_OPSIZE+137)
#define FN_verbose      (MN_OPSIZE+138)
#define FN_virtual      (MN_OPSIZE+139)
#define FN_write        (MN_OPSIZE+140)
#define FN_writeChar    (MN_OPSIZE+141)
#define FN_writechar    (MN_OPSIZE+141)
#define FN_writeData    (MN_OPSIZE+142)
#define FN_writedata    (MN_OPSIZE+142)
#define FN_x            (MN_OPSIZE+143)
