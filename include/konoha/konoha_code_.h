...
#define OPCODE_SWAP ((knh_opcode_t)29)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_PARAMDEF ((knh_opcode_t)30)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_PARAMo ((knh_opcode_t)31)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_PARAMPROP ((knh_opcode_t)32)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_PARAMS ((knh_opcode_t)33)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_CHKESP ((knh_opcode_t)34)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_YEILDBREAK ((knh_opcode_t)36)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	void *nextaddr;   /* sameas next codeaddr */
...
#define OPCODE_BOX ((knh_opcode_t)37)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_BOXnc ((knh_opcode_t)38)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_NNBOX ((knh_opcode_t)39)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_NNBOXnc ((knh_opcode_t)40)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_UNBOX ((knh_opcode_t)41)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_CHKNUL ((knh_opcode_t)42)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_CHKNULx ((knh_opcode_t)43)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfx_t a1;
...
#define OPCODE_CHKTYPE ((knh_opcode_t)44)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_FCALL ((knh_opcode_t)45)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_RCALL ((knh_opcode_t)46)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_SCALL ((knh_opcode_t)47)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_AINVOKE ((knh_opcode_t)48)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_CALL ((knh_opcode_t)49)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_ACALL ((knh_opcode_t)50)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_NEW ((knh_opcode_t)51)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_COPYSFP ((knh_opcode_t)52)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_STR ((knh_opcode_t)53)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_SSTR ((knh_opcode_t)54)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_SMAP ((knh_opcode_t)55)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_SMAPnc ((knh_opcode_t)56)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_MAP ((knh_opcode_t)57)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_MAPnc ((knh_opcode_t)58)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_AMAP ((knh_opcode_t)59)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_NNMAP ((knh_opcode_t)60)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_JMP ((knh_opcode_t)61)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
...
#define OPCODE_SKIP ((knh_opcode_t)62)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	THREADEDCODE(void *jumpaddr;)
...
#define OPCODE_bJIFT ((knh_opcode_t)63)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	THREADEDCODE(void *jumpaddr;)
...
#define OPCODE_bJIFF ((knh_opcode_t)64)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	THREADEDCODE(void *jumpaddr;)
...
#define OPCODE_bJIFF_LOOP ((knh_opcode_t)65)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	THREADEDCODE(void *jumpaddr;)
...
#define OPCODE_JIFNUL ((knh_opcode_t)66)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	THREADEDCODE(void *jumpaddr;)
...
#define OPCODE_JIFNN ((knh_opcode_t)67)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	THREADEDCODE(void *jumpaddr;)
...
#define OPCODE_NEXT ((knh_opcode_t)68)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	THREADEDCODE(void *jumpaddr;)
...
#define OPCODE_INEXT ((knh_opcode_t)69)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	THREADEDCODE(void *jumpaddr;)
...
#define OPCODE_TRY ((knh_opcode_t)70)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	THREADEDCODE(void *jumpaddr;)
...
#define OPCODE_TRYEND ((knh_opcode_t)71)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_CATCH ((knh_opcode_t)72)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	THREADEDCODE(void *jumpaddr;)
...
#define OPCODE_PUSH ((knh_opcode_t)73)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_POP ((knh_opcode_t)74)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_THROW ((knh_opcode_t)75)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_THROWs ((knh_opcode_t)76)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_THROW_AGAIN ((knh_opcode_t)77)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_P ((knh_opcode_t)78)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_flag_t a1;
...
#define OPCODE_PMSG ((knh_opcode_t)79)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_flag_t a1;
...
#define OPCODE_iCAST ((knh_opcode_t)80)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_inCAST ((knh_opcode_t)81)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fCAST ((knh_opcode_t)82)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fnCAST ((knh_opcode_t)83)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_bNOT ((knh_opcode_t)84)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iNEG ((knh_opcode_t)85)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iADD ((knh_opcode_t)86)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iADDn ((knh_opcode_t)87)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iSUB ((knh_opcode_t)88)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iSUBn ((knh_opcode_t)89)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iMUL ((knh_opcode_t)90)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iMULn ((knh_opcode_t)91)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iDIV ((knh_opcode_t)92)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iDIVn ((knh_opcode_t)93)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iMOD ((knh_opcode_t)94)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iMODn ((knh_opcode_t)95)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iEQ ((knh_opcode_t)96)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iEQn ((knh_opcode_t)97)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iNEQ ((knh_opcode_t)98)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iNEQn ((knh_opcode_t)99)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iLT ((knh_opcode_t)100)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iLTn ((knh_opcode_t)101)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iLTE ((knh_opcode_t)102)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iLTEn ((knh_opcode_t)103)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iGT ((knh_opcode_t)104)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iGTn ((knh_opcode_t)105)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iGTE ((knh_opcode_t)106)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iGTEn ((knh_opcode_t)107)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fNEG ((knh_opcode_t)108)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fADD ((knh_opcode_t)109)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fADDn ((knh_opcode_t)110)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fSUB ((knh_opcode_t)111)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fSUBn ((knh_opcode_t)112)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fMUL ((knh_opcode_t)113)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fMULn ((knh_opcode_t)114)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fDIV ((knh_opcode_t)115)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fDIVn ((knh_opcode_t)116)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fEQ ((knh_opcode_t)117)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fEQn ((knh_opcode_t)118)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fNEQ ((knh_opcode_t)119)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fNEQn ((knh_opcode_t)120)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fLT ((knh_opcode_t)121)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fLTn ((knh_opcode_t)122)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fLTE ((knh_opcode_t)123)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fLTEn ((knh_opcode_t)124)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fGT ((knh_opcode_t)125)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fGTn ((knh_opcode_t)126)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fGTE ((knh_opcode_t)127)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fGTEn ((knh_opcode_t)128)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_ARYGET ((knh_opcode_t)129)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_ARYGETn ((knh_opcode_t)130)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iARYGET ((knh_opcode_t)131)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iARYGETn ((knh_opcode_t)132)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fARYGET ((knh_opcode_t)133)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fARYGETn ((knh_opcode_t)134)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_ARYSET ((knh_opcode_t)135)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_ARYSETn ((knh_opcode_t)136)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iARYSET ((knh_opcode_t)137)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iARYSETn ((knh_opcode_t)138)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fARYSET ((knh_opcode_t)139)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fARYSETn ((knh_opcode_t)140)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_THCODE ((knh_opcode_t)141)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_NOP ((knh_opcode_t)142)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	void *nextaddr;   /* sameas next codeaddr */
