...
#define OPCODE_ARYGET ((knh_opcode_t)119)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_ARYGETn ((knh_opcode_t)120)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iARYGET ((knh_opcode_t)121)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iARYGETn ((knh_opcode_t)122)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fARYGET ((knh_opcode_t)123)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fARYGETn ((knh_opcode_t)124)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_ARYSET ((knh_opcode_t)125)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_ARYSETn ((knh_opcode_t)126)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iARYSET ((knh_opcode_t)127)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iARYSETn ((knh_opcode_t)128)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fARYSET ((knh_opcode_t)129)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fARYSETn ((knh_opcode_t)130)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_THCODE ((knh_opcode_t)131)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_NOP ((knh_opcode_t)132)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	void *nextaddr;   /* sameas next codeaddr */
