...
#define OPCODE_TRY ((knh_opcode_t)78)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	THREADEDCODE(void *jumpaddr;)
...
#define OPCODE_TRYEND ((knh_opcode_t)79)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_CATCH ((knh_opcode_t)80)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	THREADEDCODE(void *jumpaddr;)
...
#define OPCODE_PUSH ((knh_opcode_t)81)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_POP ((knh_opcode_t)82)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_THROW ((knh_opcode_t)83)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_ushort_t a1;
...
#define OPCODE_THROWs ((knh_opcode_t)84)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_ushort_t a1;
...
#define OPCODE_THROW_AGAIN ((knh_opcode_t)85)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_P ((knh_opcode_t)86)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_flag_t a1;
...
#define OPCODE_PMSG ((knh_opcode_t)87)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_flag_t a1;
...
#define OPCODE_iCAST ((knh_opcode_t)88)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_inCAST ((knh_opcode_t)89)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fCAST ((knh_opcode_t)90)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fnCAST ((knh_opcode_t)91)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_bNOT ((knh_opcode_t)92)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iNEG ((knh_opcode_t)93)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iADD ((knh_opcode_t)94)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iADDn ((knh_opcode_t)95)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iSUB ((knh_opcode_t)96)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iSUBn ((knh_opcode_t)97)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iMUL ((knh_opcode_t)98)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iMULn ((knh_opcode_t)99)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iDIV ((knh_opcode_t)100)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iDIVn ((knh_opcode_t)101)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iMOD ((knh_opcode_t)102)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iMODn ((knh_opcode_t)103)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iEQ ((knh_opcode_t)104)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iEQn ((knh_opcode_t)105)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iNEQ ((knh_opcode_t)106)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iNEQn ((knh_opcode_t)107)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iLT ((knh_opcode_t)108)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iLTn ((knh_opcode_t)109)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iLTE ((knh_opcode_t)110)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iLTEn ((knh_opcode_t)111)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iGT ((knh_opcode_t)112)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iGTn ((knh_opcode_t)113)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iGTE ((knh_opcode_t)114)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iGTEn ((knh_opcode_t)115)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fNEG ((knh_opcode_t)116)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fADD ((knh_opcode_t)117)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fADDn ((knh_opcode_t)118)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fSUB ((knh_opcode_t)119)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fSUBn ((knh_opcode_t)120)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fMUL ((knh_opcode_t)121)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fMULn ((knh_opcode_t)122)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fDIV ((knh_opcode_t)123)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fDIVn ((knh_opcode_t)124)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fEQ ((knh_opcode_t)125)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fEQn ((knh_opcode_t)126)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fNEQ ((knh_opcode_t)127)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fNEQn ((knh_opcode_t)128)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fLT ((knh_opcode_t)129)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fLTn ((knh_opcode_t)130)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fLTE ((knh_opcode_t)131)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fLTEn ((knh_opcode_t)132)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fGT ((knh_opcode_t)133)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fGTn ((knh_opcode_t)134)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fGTE ((knh_opcode_t)135)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fGTEn ((knh_opcode_t)136)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_AGET ((knh_opcode_t)137)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_AGETn ((knh_opcode_t)138)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_IAGET ((knh_opcode_t)139)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_IAGETn ((knh_opcode_t)140)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_FAGET ((knh_opcode_t)141)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_FAGETn ((knh_opcode_t)142)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_ASET ((knh_opcode_t)143)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_ASETn ((knh_opcode_t)144)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_IASET ((knh_opcode_t)145)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_IASETn ((knh_opcode_t)146)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_FASET ((knh_opcode_t)147)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_FASETn ((knh_opcode_t)148)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_INITCODE ((knh_opcode_t)149)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_NOP ((knh_opcode_t)150)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	void *nextaddr;   /* sameas next codeaddr */
