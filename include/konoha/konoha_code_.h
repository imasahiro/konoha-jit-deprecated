...
#define OPCODE_NCALL ((knh_opcode_t)54)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	void *nextaddr;   /* sameas next codeaddr */
...
#define OPCODE_FCALL ((knh_opcode_t)55)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_RCALL ((knh_opcode_t)56)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_SCALL ((knh_opcode_t)57)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_AINVOKE ((knh_opcode_t)58)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_CALL ((knh_opcode_t)59)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_ACALL ((knh_opcode_t)60)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_NEW ((knh_opcode_t)61)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_COPYSFP ((knh_opcode_t)62)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_TOSTR ((knh_opcode_t)63)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_TOSTRf ((knh_opcode_t)64)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_SMAP ((knh_opcode_t)65)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_SMAPnc ((knh_opcode_t)66)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_MAP ((knh_opcode_t)67)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_MAPnc ((knh_opcode_t)68)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_AMAP ((knh_opcode_t)69)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_NNMAP ((knh_opcode_t)70)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_JMP ((knh_opcode_t)71)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
...
#define OPCODE_SKIP ((knh_opcode_t)72)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	THREADEDCODE(void *jumpaddr;)
...
#define OPCODE_bJIFT ((knh_opcode_t)73)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	THREADEDCODE(void *jumpaddr;)
...
#define OPCODE_bJIFF ((knh_opcode_t)74)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	THREADEDCODE(void *jumpaddr;)
...
#define OPCODE_bJIFF_LOOP ((knh_opcode_t)75)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	THREADEDCODE(void *jumpaddr;)
...
#define OPCODE_JIFNUL ((knh_opcode_t)76)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	THREADEDCODE(void *jumpaddr;)
...
#define OPCODE_JIFNN ((knh_opcode_t)77)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	THREADEDCODE(void *jumpaddr;)
...
#define OPCODE_NEXT ((knh_opcode_t)78)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	THREADEDCODE(void *jumpaddr;)
...
#define OPCODE_INEXT ((knh_opcode_t)79)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	THREADEDCODE(void *jumpaddr;)
...
#define OPCODE_ARYGET ((knh_opcode_t)139)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_ARYGETn ((knh_opcode_t)140)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iARYGET ((knh_opcode_t)141)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iARYGETn ((knh_opcode_t)142)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fARYGET ((knh_opcode_t)143)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fARYGETn ((knh_opcode_t)144)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_ARYSET ((knh_opcode_t)145)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_ARYSETn ((knh_opcode_t)146)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iARYSET ((knh_opcode_t)147)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iARYSETn ((knh_opcode_t)148)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fARYSET ((knh_opcode_t)149)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fARYSETn ((knh_opcode_t)150)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_THCODE ((knh_opcode_t)151)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
