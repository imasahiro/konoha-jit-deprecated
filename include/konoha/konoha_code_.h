...
#define OPCODE_PARAMDEF ((knh_opcode_t)34)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_PARAMo ((knh_opcode_t)35)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_PARAMPROP ((knh_opcode_t)36)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_PARAMS ((knh_opcode_t)37)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_CHKESP ((knh_opcode_t)38)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_CHKNUL ((knh_opcode_t)50)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_CHKNULx ((knh_opcode_t)51)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfx_t a1;
...
#define OPCODE_CHKTYPE ((knh_opcode_t)52)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_NCALL ((knh_opcode_t)53)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	void *nextaddr;   /* sameas next codeaddr */
...
#define OPSIZE_NCALL  (sizeof(klr_NCALL_t)-sizeof(void*))
...
#define OPCODE_ARYGET ((knh_opcode_t)137)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_ARYGETn ((knh_opcode_t)138)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iARYGET ((knh_opcode_t)139)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iARYGETn ((knh_opcode_t)140)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fARYGET ((knh_opcode_t)141)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fARYGETn ((knh_opcode_t)142)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_ARYSET ((knh_opcode_t)143)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_ARYSETn ((knh_opcode_t)144)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iARYSET ((knh_opcode_t)145)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_iARYSETn ((knh_opcode_t)146)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fARYSET ((knh_opcode_t)147)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_fARYSETn ((knh_opcode_t)148)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
...
#define OPCODE_THCODE ((knh_opcode_t)149)
typedef struct {
	THREADEDCODE(void *codeaddr;)
	knh_opcode_t opcode;
	knh_sfpidx_t a1;
