...
#define TT_FMTSTR                       ((knh_term_t)72)
#define TT_REGEX                        ((knh_term_t)73)
#define TT_DOC                          ((knh_term_t)74)
#define TT_METAN                        ((knh_term_t)75)
#define TT_PROPN                        ((knh_term_t)76)
#define TT_URN                          ((knh_term_t)77)
#define TT_QPATH                        ((knh_term_t)78)
#define TT_NAME                         ((knh_term_t)79)
#define TT_UNAME                        ((knh_term_t)80)
#define TT_FUNCNAME                     ((knh_term_t)81)
#define TT_TYPE                         ((knh_term_t)82)
#define TT_CID                          ((knh_term_t)83)
#define TT_MN                           ((knh_term_t)84)
#define TT_FMT                          ((knh_term_t)85)
#define TT_MT                           ((knh_term_t)86)
#define TT_CONST                        ((knh_term_t)87)
#define TT_STMT                         ((knh_term_t)88)
#define TT_SYSVAL                       ((knh_term_t)89)
#define TT_LOCAL                        ((knh_term_t)90)
#define TT_STACK                        ((knh_term_t)91)
#define TT_FIELD                        ((knh_term_t)92)
#define TT_ERR                          ((knh_term_t)93)
#define TT_EOT                          ((knh_term_t)94)
#define TT_LET                          ((knh_term_t)95)
#define TT_SEND                         ((knh_term_t)96)
#define TT_ALT                          ((knh_term_t)97)
#define TT_QUESTION                     ((knh_term_t)98)
#define TT_OR                           ((knh_term_t)99)
#define TT_AND                          ((knh_term_t)100)
#define TT_NOT                          ((knh_term_t)101)
#define TT_EXISTS                       ((knh_term_t)102)
#define TT_IS                           ((knh_term_t)103)
#define TT_OF                           ((knh_term_t)104)
#define TT_ISA                          ((knh_term_t)105)
#define TT_IN                           ((knh_term_t)106)
#define TT_MATCH                        ((knh_term_t)107)
#define TT_EQ                           ((knh_term_t)108)
#define TT_NEQ                          ((knh_term_t)109)
#define TT_LT                           ((knh_term_t)110)
#define TT_LTE                          ((knh_term_t)111)
#define TT_GT                           ((knh_term_t)112)
#define TT_GTE                          ((knh_term_t)113)
#define TT_FROM                         ((knh_term_t)114)
#define TT_WHERE                        ((knh_term_t)115)
#define TT_TO                           ((knh_term_t)116)
#define TT_UNTIL                        ((knh_term_t)117)
#define TT_LSFT                         ((knh_term_t)118)
#define TT_RSFT                         ((knh_term_t)119)
#define TT_ADD                          ((knh_term_t)120)
#define TT_SUB                          ((knh_term_t)121)
#define TT_DIV                          ((knh_term_t)122)
#define TT_MOD                          ((knh_term_t)123)
#define TT_MUL                          ((knh_term_t)124)
#define TT_LAND                         ((knh_term_t)125)
#define TT_LOR                          ((knh_term_t)126)
#define TT_XOR                          ((knh_term_t)127)
#define TT_LNOT                         ((knh_term_t)128)
#define TT_NEXT                         ((knh_term_t)129)
#define TT_PREV                         ((knh_term_t)130)
#define TT_ITR                          ((knh_term_t)131)
#define TT_TMUL                         ((knh_term_t)132)
#define TT_TADD                         ((knh_term_t)133)
#define TT_ADDR                         ((knh_term_t)134)
#define TT_TSUB                         ((knh_term_t)135)
#define K_TOKEN_MAXSIZ                  ((knh_term_t)136)

/* ------------------------------------------------------------------------ */
#define STT_PRAGMA                      ((knh_term_t)136)
#define STT_NAMESPACE                   ((knh_term_t)137)
#define STT_SCRIPT                      ((knh_term_t)138)
#define STT_INCLUDE                     ((knh_term_t)139)
#define STT_IMPORT                      ((knh_term_t)140)
#define STT_USING                       ((knh_term_t)141)
#define STT_CLASS                       ((knh_term_t)142)
#define STT_METHOD                      ((knh_term_t)143)
#define STT_FORMAT                      ((knh_term_t)144)
#define STT_RETURN                      ((knh_term_t)145)
#define STT_YEILD                       ((knh_term_t)146)
#define STT_IF                          ((knh_term_t)147)
#define STT_SWITCH                      ((knh_term_t)148)
#define STT_CASE                        ((knh_term_t)149)
#define STT_WHILE                       ((knh_term_t)150)
#define STT_DO                          ((knh_term_t)151)
#define STT_FOR                         ((knh_term_t)152)
#define STT_FOREACH                     ((knh_term_t)153)
#define STT_BREAK                       ((knh_term_t)154)
#define STT_CONTINUE                    ((knh_term_t)155)
#define STT_GOTO                        ((knh_term_t)156)
#define STT_TRY                         ((knh_term_t)157)
#define STT_CATCH                       ((knh_term_t)158)
#define STT_THROW                       ((knh_term_t)159)
#define STT_LSEND                       ((knh_term_t)160)
#define STT_PRINT                       ((knh_term_t)161)
#define STT_ASSERT                      ((knh_term_t)162)
#define STT_CHECKIN                     ((knh_term_t)163)
#define STT_REGISTER                    ((knh_term_t)164)
#define STT_SELECT                      ((knh_term_t)165)
#define STT_GO                          ((knh_term_t)166)
#define STT_FUNCTION                    ((knh_term_t)167)
#define STT_BLOCK                       ((knh_term_t)168)
#define STT_DONE                        ((knh_term_t)169)
#define STT_DECL                        ((knh_term_t)170)
#define STT_LETM                        ((knh_term_t)171)
#define STT_PUSHM                       ((knh_term_t)172)
#define STT_CMD                         ((knh_term_t)173)
#define STT_EXTRA                       ((knh_term_t)174)
#define STT_ERR                         ((knh_term_t)175)
#define STT_LET                         ((knh_term_t)176)
#define STT_NEW                         ((knh_term_t)177)
#define STT_TCAST                       ((knh_term_t)178)
#define STT_QCAST                       ((knh_term_t)179)
#define STT_FUNC                        ((knh_term_t)180)
#define STT_CALL                        ((knh_term_t)181)
#define STT_PCALL                       ((knh_term_t)182)
#define STT_MT                          ((knh_term_t)183)
#define STT_FMT                         ((knh_term_t)184)
#define STT_OP                          ((knh_term_t)185)
#define STT_TRI                         ((knh_term_t)186)
#define STT_ALT                         ((knh_term_t)187)
#define STT_AND                         ((knh_term_t)188)
#define STT_OR                          ((knh_term_t)189)
#define STT_W                           ((knh_term_t)190)
#define STT_CALL1                       ((knh_term_t)191)
#define K_STMT_MAXSIZ                   ((knh_term_t)192)
