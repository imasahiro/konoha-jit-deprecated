...
#define TT_ADDR                         ((knh_term_t)133)
#define TT_TSUB                         ((knh_term_t)134)
#define K_TOKEN_MAXSIZ                  ((knh_term_t)135)

/* ------------------------------------------------------------------------ */
#define STT_PRAGMA                      ((knh_term_t)135)
#define STT_NAMESPACE                   ((knh_term_t)136)
#define STT_SCRIPT                      ((knh_term_t)137)
#define STT_INCLUDE                     ((knh_term_t)138)
#define STT_IMPORT                      ((knh_term_t)139)
#define STT_USING                       ((knh_term_t)140)
#define STT_CLASS                       ((knh_term_t)141)
#define STT_METHOD                      ((knh_term_t)142)
#define STT_FORMAT                      ((knh_term_t)143)
#define STT_RETURN                      ((knh_term_t)144)
#define STT_YEILD                       ((knh_term_t)145)
#define STT_IF                          ((knh_term_t)146)
#define STT_SWITCH                      ((knh_term_t)147)
#define STT_CASE                        ((knh_term_t)148)
#define STT_WHILE                       ((knh_term_t)149)
#define STT_DO                          ((knh_term_t)150)
#define STT_FOR                         ((knh_term_t)151)
#define STT_FOREACH                     ((knh_term_t)152)
#define STT_BREAK                       ((knh_term_t)153)
#define STT_CONTINUE                    ((knh_term_t)154)
#define STT_GOTO                        ((knh_term_t)155)
#define STT_TRY                         ((knh_term_t)156)
#define STT_CATCH                       ((knh_term_t)157)
#define STT_THROW                       ((knh_term_t)158)
#define STT_LSEND                       ((knh_term_t)159)
#define STT_PRINT                       ((knh_term_t)160)
#define STT_ASSERT                      ((knh_term_t)161)
#define STT_CHECKIN                     ((knh_term_t)162)
#define STT_REGISTER                    ((knh_term_t)163)
#define STT_SELECT                      ((knh_term_t)164)
#define STT_GO                          ((knh_term_t)165)
#define STT_FUNCTION                    ((knh_term_t)166)
#define STT_BLOCK                       ((knh_term_t)167)
#define STT_DONE                        ((knh_term_t)168)
#define STT_DECL                        ((knh_term_t)169)
#define STT_LETM                        ((knh_term_t)170)
#define STT_PUSHM                       ((knh_term_t)171)
#define STT_CMD                         ((knh_term_t)172)
#define STT_EXTRA                       ((knh_term_t)173)
#define STT_ERR                         ((knh_term_t)174)
...
#define MN_opEQ                         ((knh_methodn_t)12)
#define MN_opNOTEQ                      ((knh_methodn_t)13)
#define MN_opLT                         ((knh_methodn_t)14)
#define MN_opLTE                        ((knh_methodn_t)15)
#define MN_opGT                         ((knh_methodn_t)16)
#define MN_opGTE                        ((knh_methodn_t)17)
#define MN_opFROM                       ((knh_methodn_t)18)
#define MN_opWHERE                      ((knh_methodn_t)19)
#define MN_opTO                         ((knh_methodn_t)20)
#define MN_opUNTIL                      ((knh_methodn_t)21)
...
#define MN_opLAND                       ((knh_methodn_t)29)
#define MN_opLOR                        ((knh_methodn_t)30)
#define MN_opLXOR                       ((knh_methodn_t)31)
#define MN_opLNOT                       ((knh_methodn_t)32)
#define MN_opNEXT                       ((knh_methodn_t)33)
#define MN_opPREV                       ((knh_methodn_t)34)
#define MN_opITR                        ((knh_methodn_t)35)
#define MN_opEXPAND                     ((knh_methodn_t)36)
#define MN_opPLUS                       ((knh_methodn_t)37)
#define MN_opADDR                       ((knh_methodn_t)38)
#define MN_opNEG                        ((knh_methodn_t)39)
#define MN_OPSIZE                       ((knh_methodn_t)40)
