...
static knh_data_t ParamArrayData0[] = {
	...
	DATA_PARAM/*16*/, 0, 1, 1, TYPE_T1, FN_key, TYPE_Boolean, FN_return,
	DATA_PARAM/*17*/, 0, 1, 1, TYPE_T1, FN_key, TYPE_T2, FN_return,
	DATA_PARAM/*18*/, 0, 2, 0, TYPE_T1, FN_key, TYPE_T2, FN_value,
	DATA_PARAM/*19*/, 0, 1, 0, TYPE_T1, FN_key,
	DATA_PARAM/*20*/, 0, 1, 0, TYPE_OutputStream, FN_w,
	DATA_PARAM/*21*/, 0, 0, 1, TYPE_StringITR, FN_return,
	DATA_PARAM/*22*/, 0, 0, 1, TYPE_T1ITR, FN_return,
	DATA_PARAM/*23*/, 0, 0, 1, TYPE_ThisITR, FN_return,
	DATA_PARAM/*24*/, 0, 0, 1, TYPE_This, FN_return,
	DATA_PARAM/*25*/, FLAG_ParamArray_VARGs, 1, 1, TYPE_Any, FN_value, TYPE_This, FN_return,
	DATA_PARAM/*26*/, 0, 1, 1, TYPE_Int, FN_init, TYPE_Bytes, FN_return,
	DATA_PARAM/*27*/, 0, 2, 1, TYPE_Bytes, FN_buf, TYPE_StringDecoder, FN_c, TYPE_String, FN_return,
	DATA_PARAM/*28*/, 0, 3, 1, TYPE_String, FN_pattern, TYPE_String, FN_option, TYPE_NameSpace, FN_ns, TYPE_Regex, FN_return,
	DATA_PARAM/*29*/, FLAG_ParamArray_VARGs, 3, 1, TYPE_T1, FN_k, TYPE_T2, FN_v, TYPE_Any, FN_value, TYPE_This, FN_return,
	DATA_PARAM/*30*/, 0, 2, 1, TYPE_T1, FN_start, TYPE_T1, FN_end, TYPE_This, FN_return,
	DATA_PARAM/*31*/, 0, 1, 1, TYPE_Int, FN_initCapacity, TYPE_This, FN_return,
	DATA_PARAM/*32*/, 0, 1, 1, TYPE_Int, FN_size, TYPE_This, FN_return,
	DATA_PARAM/*33*/, FLAG_ParamArray_VARGs, 1, 1, TYPE_T1, FN_value, TYPE_This, FN_return,
	DATA_PARAM/*34*/, 0, 1, 1, TYPE_String, FN_path, TYPE_This, FN_return,
	DATA_PARAM/*35*/, 0, 2, 1, TYPE_String, FN_msg, TYPE_Any, FN_bag, TYPE_Exception, FN_return,
	DATA_PARAM/*36*/, 0, 2, 1, TYPE_Any, FN_base, TYPE_Method, FN_method, TYPE_This, FN_return,
	DATA_PARAM/*37*/, 0, 1, 0, TYPE_Int, FN_seed,
	DATA_PARAM/*38*/, 0, 1, 1, TYPE_Int, FN_n, TYPE_Int, FN_return,
	DATA_PARAM/*39*/, 0, 0, 1, TYPE_Float, FN_return,
	DATA_PARAM/*40*/, 0, 1, 1, TYPE_Float, FN_n, TYPE_Int, FN_return,
	DATA_PARAM/*41*/, 0, 1, 1, TYPE_Int, FN_n, TYPE_Float, FN_return,
	DATA_PARAM/*42*/, 0, 0, 1, TYPE_Class, FN_return,
	DATA_PARAM/*43*/, 0, 0, 1, TYPE_String, FN_return,
	DATA_PARAM/*44*/, 0, 0, 1, TYPE_Array, FN_return,
	DATA_PARAM/*45*/, FLAG_ParamArray_VARGs, 1, 1, TYPE_Any, FN_v, TYPE_String, FN_return,
	DATA_PARAM/*46*/, FLAG_ParamArray_VARGs, 1, 1, TYPE_Object, FN_v, TYPE_String, FN_return,
	DATA_PARAM/*47*/, 0, 1, 1, TYPE_Any, FN_x, TYPE_Any, FN_return,
	DATA_PARAM/*48*/, 0, 1, 1, TYPE_Class, FN_c, TYPE_Boolean, FN_return,
	DATA_PARAM/*49*/, 0, 1, 1, TYPE_Any, FN_value, TYPE_Boolean, FN_return,
	...
	DATA_PARAM/*53*/, 0, 1, 1, TYPE_Any, FN_v, TYPE_Boolean, FN_return,
	...
	DATA_PARAM/*58*/, 0, 1, 1, TYPE_Any, FN_value, TYPE_Any, FN_return,
	DATA_PARAM/*59*/, 0, 0, 1, TYPE_Any, FN_return,
	...
	DATA_PARAM/*67*/, 0, 0, 1, TYPE_T1, FN_return,
	DATA_PARAM/*68*/, 0, 2, 1, TYPE_String, FN_urn, TYPE_String, FN_mode, TYPE_InputStream, FN_return,
	DATA_PARAM/*69*/, 0, 3, 1, TYPE_Bytes, FN_buf, TYPE_Int, FN_offset, TYPE_Int, FN_length, TYPE_Int, FN_return,
	DATA_PARAM/*70*/, 0, 1, 1, TYPE_StringDecoder, FN_c, TYPE_StringDecoder, FN_return,
	DATA_PARAM/*71*/, 0, 2, 1, TYPE_String, FN_urn, TYPE_String, FN_mode, TYPE_OutputStream, FN_return,
	DATA_PARAM/*72*/, 0, 1, 0, TYPE_Int, FN_ch,
	DATA_PARAM/*73*/, FLAG_ParamArray_VARGs, 1, 0, TYPE_Object, FN_value,
	DATA_PARAM/*74*/, FLAG_ParamArray_VARGs, 1, 0, TYPE_Any, FN_value,
	DATA_PARAM/*75*/, FLAG_ParamArray_VARGs, 1, 0, TYPE_Object, FN_data,
	DATA_PARAM/*76*/, 0, 1, 1, TYPE_StringEncoder, FN_c, TYPE_StringEncoder, FN_return,
	DATA_PARAM/*77*/, 0, 1, 1, TYPE_Class, FN_c, TYPE_Any, FN_return,
	DATA_PARAM/*78*/, FLAG_ParamArray_VARGs, 1, 1, TYPE_Object, FN_value, TYPE_String, FN_return,
	DATA_PARAM/*79*/, 0, 1, 1, TYPE_Any, FN_value, TYPE_String, FN_return,
	DATA_PARAM/*80*/, 0, 1, 1, TYPE_Regex, FN_re, TYPE_Int, FN_return,
	DATA_PARAM/*81*/, 0, 2, 1, TYPE_Regex, FN_re, TYPE_String, FN_s, TYPE_String, FN_return,
	DATA_PARAM/*82*/, 0, 1, 1, TYPE_Regex, FN_re, TYPE_StringARRAY, FN_return,
	DATA_PARAM/*83*/, 0, 1, 1, TYPE_Converter, FN_enc, TYPE_Bytes, FN_return,
	DATA_PARAM/*84*/, 0, 1, 1, TYPE_StringEncoder, FN_enc, TYPE_Bytes, FN_return,
	DATA_PARAM/*85*/, 0, 1, 1, TYPE_StringDecoder, FN_c, TYPE_String, FN_return,
	DATA_PARAM/*86*/, 0, 1, 1, TYPE_StringConverter, FN_c, TYPE_String, FN_return,
	DATA_PARAM/*87*/, 0, 1, 1, TYPE_Regex, FN_re, TYPE_Boolean, FN_return,
	DATA_PARAM/*88*/, 0, 0, 1, TYPE_InputStream, FN_return,
	DATA_PARAM/*89*/, 0, 0, 1, TYPE_OutputStream, FN_return,
	DATA_PARAM/*90*/, 0, 1, 1, TYPE_String, FN_key, TYPE_Any, FN_return,
	DATA_PARAM/*91*/, 0, 2, 1, TYPE_String, FN_key, TYPE_Any, FN_value, TYPE_Any, FN_return,
	DATA_PARAM/*92*/, 0, 1, 1, TYPE_String, FN_key, TYPE_StringARRAY, FN_return,
	DATA_PARAM/*93*/, 0, 1, 0, TYPE_Int, FN_status,
	DATA_PARAM/*94*/, 0, 1, 1, TYPE_InputStream, FN_in, TYPE_InputStream, FN_return,
	DATA_PARAM/*95*/, 0, 1, 1, TYPE_OutputStream, FN_out, TYPE_OutputStream, FN_return,
	DATA_PARAM/*96*/, 0, 1, 1, TYPE_Any, FN_msg, TYPE_Boolean, FN_return,
	DATA_PARAM/*97*/, 0, 2, 1, TYPE_String, FN_name, TYPE_Object, FN_value, TYPE_Any, FN_return,
	DATA_PARAM/*98*/, 0, 1, 1, TYPE_Boolean, FN_flag, TYPE_Boolean, FN_return,
	0
};
#define K_PARAM0_SIZE                   99
...
static knh_data_t APIData0[] = {
	...
	DATA_METHOD0, CLASS_Map, MN_opHAS, 0, _DATA(Map_opHAS), /*P=*/16,
	DATA_METHOD0, CLASS_Map, MN_get, 0, _DATA(Map_get), /*P=*/17,
	DATA_METHOD0, CLASS_Map, MN_set, 0, _DATA(DictMap_set), /*P=*/18,
	DATA_METHOD0, CLASS_Map, MN_remove, 0, _DATA(DictMap_remove), /*P=*/19,
	DATA_METHOD0, CLASS_Object, MN__empty, 0, _DATA(Object__empty), /*P=*/20,
	DATA_METHOD0, CLASS_Object, MN__s, 0, _DATA(Object__s), /*P=*/20,
	DATA_METHOD0, CLASS_Boolean, MN__s, 0, _DATA(Boolean__s), /*P=*/20,
	DATA_METHOD0, CLASS_Boolean, MN__k, 0, _DATA(Boolean__s), /*P=*/20,
	DATA_METHOD0, CLASS_Boolean, MN__data, 0, _DATA(Boolean__s), /*P=*/20,
	DATA_METHOD0, CLASS_Boolean, MN__dump, 0, _DATA(Boolean__s), /*P=*/20,
	DATA_METHOD0, CLASS_Int, MN__s, 0, _DATA(Int__s), /*P=*/20,
	DATA_METHOD0, CLASS_Float, MN__s, 0, _DATA(Float__s), /*P=*/20,
	DATA_METHOD0, CLASS_String, MN__s, 0, _DATA(String__s), /*P=*/20,
	DATA_METHOD0, CLASS_Bytes, MN__s, 0, _DATA(Bytes__s), /*P=*/20,
	DATA_METHOD0, CLASS_Regex, MN__s, 0, _DATA(Regex__s), /*P=*/20,
	DATA_METHOD0, CLASS_Class, MN__s, 0, _DATA(Class__s), /*P=*/20,
	DATA_METHOD0, CLASS_Method, MN__s, 0, _DATA(Method__s), /*P=*/20,
	DATA_METHOD0, CLASS_Exception, MN__s, 0, _DATA(Exception__s), /*P=*/20,
	DATA_METHOD0, CLASS_Object, MN__k, 0, _DATA(Object__k), /*P=*/20,
	DATA_METHOD0, CLASS_Int, MN__k, 0, _DATA(Int__k), /*P=*/20,
	DATA_METHOD0, CLASS_Int, MN__data, 0, _DATA(Int__k), /*P=*/20,
	DATA_METHOD0, CLASS_Int, MN__dump, 0, _DATA(Int__k), /*P=*/20,
	DATA_METHOD0, CLASS_Float, MN__k, 0, _DATA(Float__k), /*P=*/20,
	DATA_METHOD0, CLASS_Float, MN__data, 0, _DATA(Float__k), /*P=*/20,
	DATA_METHOD0, CLASS_Float, MN__dump, 0, _DATA(Float__k), /*P=*/20,
	DATA_METHOD0, CLASS_String, MN__k, 0, _DATA(String__k), /*P=*/20,
	DATA_METHOD0, CLASS_Iterator, MN__k, 0, _DATA(Iterator__k), /*P=*/20,
	DATA_METHOD0, CLASS_Tuple, MN__k, 0, _DATA(Tuple__k), /*P=*/20,
	DATA_METHOD0, CLASS_Range, MN__k, 0, _DATA(Range__k), /*P=*/20,
	DATA_METHOD0, CLASS_Array, MN__k, 0, _DATA(Array__k), /*P=*/20,
	DATA_METHOD0, CLASS_Map, MN__k, 0, _DATA(Map__k), /*P=*/20,
	DATA_METHOD0, CLASS_Class, MN__k, 0, _DATA(Class__k), /*P=*/20,
	DATA_METHOD0, CLASS_Method, MN__k, 0, _DATA(Method__k), /*P=*/20,
	DATA_METHOD0, CLASS_Translator, MN__k, 0, _DATA(Translator__k), /*P=*/20,
	DATA_METHOD0, CLASS_Exception, MN__k, 0, _DATA(Exception__k), /*P=*/20,
	DATA_METHOD0, CLASS_InputStream, MN__k, 0, _DATA(InputStream__k), /*P=*/20,
	DATA_METHOD0, CLASS_OutputStream, MN__k, 0, _DATA(OutputStream__k), /*P=*/20,
	DATA_METHOD0, CLASS_Script, MN__k, 0, _DATA(Script__k), /*P=*/20,
	DATA_METHOD0, CLASS_Any, MN__s, 0, _DATA(Any__k), /*P=*/20,
	DATA_METHOD0, CLASS_Any, MN__k, 0, _DATA(Any__k), /*P=*/20,
	DATA_METHOD0, CLASS_Object, MN__dump, 0, _DATA(Object__dump), /*P=*/20,
	DATA_METHOD0, CLASS_Bytes, MN__dump, 0, _DATA(Bytes__dump), /*P=*/20,
	DATA_METHOD0, CLASS_Class, MN__dump, 0, _DATA(Class__dump), /*P=*/20,
	DATA_METHOD0, CLASS_Method, MN__dump, 0, _DATA(Method__dump), /*P=*/20,
	DATA_METHOD0, CLASS_Exception, MN__dump, 0, _DATA(Exception__dump), /*P=*/20,
	DATA_METHOD0, CLASS_Object, MN__data, 0, _DATA(Object__data), /*P=*/20,
	DATA_METHOD0, CLASS_String, MN__data, 0, _DATA(String__data), /*P=*/20,
	DATA_METHOD0, CLASS_Bytes, MN__data, 0, _DATA(Bytes__data), /*P=*/20,
	DATA_METHOD0, CLASS_Array, MN__data, 0, _DATA(Array__data), /*P=*/20,
	DATA_METHOD0, CLASS_Map, MN__data, 0, _DATA(Map__data), /*P=*/20,
	DATA_METHOD0, CLASS_Exception, MN__data, 0, _DATA(Exception__data), /*P=*/20,
	DATA_METHOD0, CLASS_Func, MN__data, 0, _DATA(Func__data), /*P=*/20,
	DATA_METHOD0, CLASS_Class, MN__man, 0, _DATA(Class__man), /*P=*/20,
	DATA_METHOD0, CLASS_Object, MN__man, 0, _DATA(Class__man), /*P=*/20,
	DATA_METHOD0, CLASS_Object, MN__p, 0, _DATA(Object__p), /*P=*/20,
	DATA_METHOD0, CLASS_Int, MN__c, 0, _DATA(Int__c), /*P=*/20,
	DATA_METHOD0, CLASS_Int, MN__d, 0, _DATA(Int__d), /*P=*/20,
	DATA_METHOD0, CLASS_Int, MN__u, 0, _DATA(Int__u), /*P=*/20,
	DATA_METHOD0, CLASS_Int, MN__f, 0, _DATA(Int__f), /*P=*/20,
	DATA_METHOD0, CLASS_Int, MN__x, 0, _DATA(Int__x), /*P=*/20,
	DATA_METHOD0, CLASS_Int, MN__bits, 0, _DATA(Int__bits), /*P=*/20,
	DATA_METHOD0, CLASS_Float, MN__d, 0, _DATA(Float__d), /*P=*/20,
	DATA_METHOD0, CLASS_Float, MN__f, 0, _DATA(Float__f), /*P=*/20,
	DATA_METHOD0, CLASS_Float, MN__bits, 0, _DATA(Float__bits), /*P=*/20,
	DATA_METHOD0, CLASS_String, MN_opITR, 0, _DATA(String_Iterator), /*P=*/21,
	DATA_METHOD0, CLASS_Range, MN_opITR, 0, _DATA(Range_Iterator), /*P=*/22,
	DATA_METHOD0, CLASS_Array, MN_opITR, 0, _DATA(Array_Iterator), /*P=*/22,
	DATA_METHOD0, CLASS_Map, MN_opITR, 0, _DATA(DictMap_String__), /*P=*/21,
	DATA_METHOD0, CLASS_Object, MN_opITR, 0, _DATA(Object_Iterator), /*P=*/23,
	DATA_METHOD0, CLASS_Object, MN_new, FLAG_Method_Virtual, _DATA(Object_new), /*P=*/24,
	DATA_METHOD0, CLASS_Object, MN_new__MAP, FLAG_Method_Hidden, _DATA(Object_new__MAP), /*P=*/25,
	DATA_METHOD0, CLASS_Bytes, MN_new, 0, _DATA(Bytes_new), /*P=*/26,
	DATA_METHOD0, CLASS_Bytes, MN_new__ARRAY, 0, _DATA(Bytes_new__ARRAY), /*P=*/26,
	DATA_METHOD0, CLASS_String, MN_new, 0, _DATA(String_new), /*P=*/27,
	DATA_METHOD0, CLASS_Regex, MN_new, FLAG_Method_Const, _DATA(Regex_new), /*P=*/28,
	DATA_METHOD0, CLASS_Tuple, MN_new__TUPLE, FLAG_Method_Const|FLAG_Method_Hidden, _DATA(Tuple_new__TUPLE), /*P=*/29,
	DATA_METHOD0, CLASS_Range, MN_new__LIST, FLAG_Method_Const|FLAG_Method_Hidden, _DATA(Range_new__LIST), /*P=*/30,
	DATA_METHOD0, CLASS_Range, MN_new__RANGE, FLAG_Method_Const|FLAG_Method_Hidden, _DATA(Range_new__RANGE), /*P=*/30,
	DATA_METHOD0, CLASS_Array, MN_new, 0, _DATA(Array_new), /*P=*/31,
	DATA_METHOD0, CLASS_Array, MN_new__ARRAY, FLAG_Method_Hidden, _DATA(Array_new__ARRAY), /*P=*/32,
	DATA_METHOD0, CLASS_Array, MN_new__LIST, FLAG_Method_Hidden, _DATA(Array_new__LIST), /*P=*/33,
	DATA_METHOD0, CLASS_Map, MN_new, 0, _DATA(Map_new), /*P=*/34,
	DATA_METHOD0, CLASS_Map, MN_new__MAP, FLAG_Method_Hidden, _DATA(Map_new__MAP), /*P=*/33,
	DATA_METHOD0, CLASS_Exception, MN_new, 0, _DATA(Exception_new), /*P=*/35,
	DATA_METHOD0, CLASS_Func, MN_new, 0, _DATA(Func_new), /*P=*/36,
	DATA_METHOD0, CLASS_System, MN_setRandomSeed, FLAG_Method_Static, _DATA(System_setRandomSeed), /*P=*/37,
	DATA_METHOD0, CLASS_Int, MN_random, FLAG_Method_Static, _DATA(Int_random), /*P=*/38,
	DATA_METHOD0, CLASS_Float, MN_random, FLAG_Method_Static, _DATA(Float_random), /*P=*/39,
	DATA_METHOD0, CLASS_Float, MN_floatToIntBits, FLAG_Method_Static, _DATA(Float_floatToIntBits), /*P=*/40,
	DATA_METHOD0, CLASS_Float, MN_intToFloatBits, FLAG_Method_Static, _DATA(Float_intToFloatBits), /*P=*/41,
	DATA_METHOD0, CLASS_Object, MN_getClass, FLAG_Method_Const, _DATA(Object_getClass), /*P=*/42,
	...
	DATA_METHOD0, CLASS_Object, MN_getKey, FLAG_Method_Const|FLAG_Method_Virtual, _DATA(Object_getKey), /*P=*/43,
	DATA_METHOD0, CLASS_Class, MN_domain, FLAG_Method_Hidden, _DATA(Class_domain), /*P=*/44,
	DATA_METHOD0, CLASS_Method, MN_isAbstract, FLAG_Method_Const, _DATA(Method_isAbstract), /*P=*/10,
	DATA_METHOD0, CLASS_Method, MN_getName, FLAG_Method_Const, _DATA(Method_getName), /*P=*/43,
	DATA_METHOD0, CLASS_Method, MN_format, FLAG_Method_Const|FLAG_Method_Hidden, _DATA(Method_format), /*P=*/45,
	DATA_METHOD0, CLASS_Method, MN_format__FINAL, FLAG_Method_Const|FLAG_Method_Hidden, _DATA(Method_format__FINAL), /*P=*/46,
	DATA_METHOD0, CLASS_Func, MN_invoke, FLAG_Method_Hidden|FLAG_Method_Private, _DATA(Func_invoke), /*P=*/47,
	...
	DATA_METHOD0, CLASS_Range, MN_opHAS, 0, _DATA(Range_opHAS), /*P=*/53,
	DATA_METHOD0, CLASS_Range, MN_opCASE, 0, _DATA(Range_opHAS), /*P=*/53,
	DATA_METHOD0, CLASS_Array, MN_opHAS, 0, _DATA(Array_opHAS), /*P=*/53,
	DATA_METHOD0, CLASS_Array, MN_opCASE, 0, _DATA(Array_opHAS), /*P=*/53,
	DATA_METHOD0, CLASS_Tuple, MN_opHAS, 0, _DATA(Tuple_opHAS), /*P=*/53,
	DATA_METHOD0, CLASS_Tuple, MN_opCASE, 0, _DATA(Tuple_opHAS), /*P=*/53,
	DATA_METHOD0, CLASS_Object, MN_opCASE, FLAG_Method_Const, _DATA(Object_opCASE), /*P=*/53,
	DATA_METHOD0, CLASS_Int, MN_opCASE, FLAG_Method_Const, _DATA(Int_opCASE), /*P=*/53,
	DATA_METHOD0, CLASS_Float, MN_opCASE, FLAG_Method_Const, _DATA(Float_opCASE), /*P=*/53,
	...
	DATA_METHOD0, CLASS_Int, MN_opSUB, FLAG_Method_Const, _DATA(Int_opSUB), /*P=*/38,
	DATA_METHOD0, CLASS_Int, MN_opMUL, FLAG_Method_Const, _DATA(Int_opMUL), /*P=*/38,
	DATA_METHOD0, CLASS_Int, MN_opDIV, FLAG_Method_Const, _DATA(Int_opDIV), /*P=*/38,
	DATA_METHOD0, CLASS_Int, MN_opMOD, FLAG_Method_Const, _DATA(Int_opMOD), /*P=*/38,
	DATA_METHOD0, CLASS_Float, MN_opADD, FLAG_Method_Const, _DATA(Float_opADD), /*P=*/55,
	DATA_METHOD0, CLASS_Float, MN_opNEG, FLAG_Method_Const, _DATA(Float_opNEG), /*P=*/39,
	...
	DATA_METHOD0, CLASS_Any, MN_opADD, 0, _DATA(Any_opADD), /*P=*/58,
	DATA_METHOD0, CLASS_Any, MN_opSUB, 0, _DATA(Any_opADD), /*P=*/58,
	DATA_METHOD0, CLASS_Any, MN_opMUL, 0, _DATA(Any_opADD), /*P=*/58,
	DATA_METHOD0, CLASS_Any, MN_opDIV, 0, _DATA(Any_opADD), /*P=*/58,
	DATA_METHOD0, CLASS_Any, MN_opMOD, 0, _DATA(Any_opADD), /*P=*/58,
	DATA_METHOD0, CLASS_Any, MN_opNEG, 0, _DATA(Any_opADD), /*P=*/59,
	...
	DATA_METHOD0, CLASS_Int, MN_opLXOR, FLAG_Method_Const, _DATA(Int_opLXOR), /*P=*/38,
	DATA_METHOD0, CLASS_Int, MN_opLNOT, FLAG_Method_Const, _DATA(Int_opLNOT), /*P=*/9,
	DATA_METHOD0, CLASS_Int, MN_opLSFT, FLAG_Method_Const, _DATA(Int_opLSFT), /*P=*/38,
	DATA_METHOD0, CLASS_Int, MN_opRSFT, FLAG_Method_Const, _DATA(Int_opRSFT), /*P=*/38,
	...
	DATA_METHOD0, CLASS_Map, MN_getSize, 0, _DATA(Map_getSize), /*P=*/9,
	DATA_METHOD0, CLASS_Tuple, MN_getSize, 0, _DATA(Tuple_getSize), /*P=*/9,
	DATA_METHOD0, CLASS_Bytes, MN_get, 0, _DATA(Bytes_get), /*P=*/38,
	...
	DATA_METHOD0, CLASS_Tuple, MN_opEXPAND, 0, _DATA(Tuple_opEXPAND), /*P=*/59,
	DATA_METHOD0, CLASS_Array, MN_opEXPAND, 0, _DATA(Array_opEXPAND), /*P=*/67,
	DATA_METHOD0, CLASS_InputStream, MN_new, 0, _DATA(InputStream_new), /*P=*/68,
	DATA_METHOD0, CLASS_InputStream, MN_getChar, 0, _DATA(InputStream_getChar), /*P=*/9,
	DATA_METHOD0, CLASS_InputStream, MN_read, 0, _DATA(InputStream_read), /*P=*/69,
	...
	DATA_METHOD0, CLASS_InputStream, MN_setCharset, 0, _DATA(InputStream_setCharset), /*P=*/70,
	DATA_METHOD0, CLASS_InputStream, MN_readLine, 0, _DATA(InputStream_readLine), /*P=*/43,
	DATA_METHOD0, CLASS_OutputStream, MN_new, 0, _DATA(OutputStream_new), /*P=*/71,
	DATA_METHOD0, CLASS_OutputStream, MN_writeChar, 0, _DATA(OutputStream_writeChar), /*P=*/72,
	...
	DATA_METHOD0, CLASS_OutputStream, MN_print, 0, _DATA(OutputStream_print), /*P=*/73,
	DATA_METHOD0, CLASS_OutputStream, MN_opSEND, 0, _DATA(OutputStream_opSEND), /*P=*/73,
	DATA_METHOD0, CLASS_OutputStream, MN_println, 0, _DATA(OutputStream_println), /*P=*/74,
	DATA_METHOD0, CLASS_OutputStream, MN_writeData, 0, _DATA(OutputStream_writeData), /*P=*/75,
	...
	DATA_METHOD0, CLASS_OutputStream, MN_setCharset, 0, _DATA(OutputStream_setCharaset), /*P=*/76,
	DATA_METHOD0, CLASS_String, MN_opEXISTS, FLAG_Method_Const, _DATA(String_opEXISTS), /*P=*/10,
	DATA_METHOD0, CLASS_String, MN_opPATH, FLAG_Method_Hidden|FLAG_Method_Private, _DATA(String_opPATH), /*P=*/77,
	...
	DATA_METHOD0, CLASS_String, MN_concat, FLAG_Method_Const, _DATA(String_concat), /*P=*/78,
	DATA_METHOD0, CLASS_String, MN_opADD, FLAG_Method_Const, _DATA(String_concat), /*P=*/79,
	DATA_METHOD0, CLASS_String, MN_indexOf, FLAG_Method_Const, _DATA(String_indexOf), /*P=*/80,
	DATA_METHOD0, CLASS_String, MN_lastIndexOf, FLAG_Method_Const, _DATA(String_lastIndexOf), /*P=*/80,
	DATA_METHOD0, CLASS_String, MN_replace, FLAG_Method_Const, _DATA(String_replace), /*P=*/81,
	DATA_METHOD0, CLASS_String, MN_split, FLAG_Method_Const, _DATA(String_split), /*P=*/82,
	DATA_METHOD0, CLASS_Bytes, MN_, FLAG_Method_Const, _DATA(Bytes_convert), /*P=*/83,
	DATA_METHOD0, CLASS_String, MN_encode, FLAG_Method_Const, _DATA(String_encode), /*P=*/84,
	DATA_METHOD0, CLASS_Bytes, MN_decode, FLAG_Method_Const, _DATA(Bytes_toString), /*P=*/85,
	DATA_METHOD0, CLASS_String, MN_, FLAG_Method_Const, _DATA(String_convert), /*P=*/86,
	DATA_METHOD0, CLASS_String, MN_convert, FLAG_Method_Const, _DATA(String_convert), /*P=*/86,
	DATA_METHOD0, CLASS_String, MN_trim, FLAG_Method_Const, _DATA(String_trim), /*P=*/43,
	DATA_METHOD0, CLASS_String, MN_opCASE, 0, _DATA(String_opCASE), /*P=*/87,
	DATA_METHOD0, CLASS_Regex, MN_opCASE, 0, _DATA(Regex_opCASE), /*P=*/52,
	DATA_METHOD0, CLASS_System, MN_getIn, FLAG_Method_Static, _DATA(System_getIn), /*P=*/88,
	DATA_METHOD0, CLASS_System, MN_getOut, FLAG_Method_Static, _DATA(System_getOut), /*P=*/89,
	DATA_METHOD0, CLASS_System, MN_getErr, FLAG_Method_Static, _DATA(System_getErr), /*P=*/89,
	DATA_METHOD0, CLASS_System, MN_getProperty, FLAG_Method_Static, _DATA(System_getProperty), /*P=*/90,
	DATA_METHOD0, CLASS_System, MN_setProperty, FLAG_Method_Static, _DATA(System_setProperty), /*P=*/91,
	DATA_METHOD0, CLASS_System, MN_listProperties, FLAG_Method_Hidden, _DATA(System_listProperties), /*P=*/92,
	DATA_METHOD0, CLASS_System, MN_gc, FLAG_Method_Static, _DATA(System_gc), /*P=*/0,
	DATA_METHOD0, CLASS_System, MN_push, FLAG_Method_Static|FLAG_Method_Hidden, _DATA(System_push), /*P=*/73,
	DATA_METHOD0, CLASS_System, MN_getTime, 0, _DATA(System_getTime), /*P=*/9,
	DATA_METHOD0, CLASS_System, MN_exit, FLAG_Method_Static, _DATA(System_exit), /*P=*/93,
	DATA_METHOD0, CLASS_Context, MN_setIn, FLAG_Method_Static, _DATA(Context_setIn), /*P=*/94,
	DATA_METHOD0, CLASS_Context, MN_setOut, FLAG_Method_Static, _DATA(Context_setOut), /*P=*/95,
	DATA_METHOD0, CLASS_Context, MN_setErr, FLAG_Method_Static, _DATA(Context_setErr), /*P=*/95,
	DATA_METHOD0, CLASS_Exception, MN_opOF, 0, _DATA(Exception_opOF), /*P=*/96,
	DATA_METHOD0, CLASS_NameSpace, MN_setConst, FLAG_Method_Const|FLAG_Method_Hidden, _DATA(NameSpace_setConst), /*P=*/97,
	DATA_METHOD0, CLASS_Class, MN_setConst, FLAG_Method_Const|FLAG_Method_Hidden, _DATA(Class_setConst), /*P=*/97,
	...
	DATA_METHOD0, CLASS_Object, MN_setModified, 0, _DATA(Object_setModified), /*P=*/98,
	DATA_METHOD0, CLASS_Object, MN_isShared, 0, _DATA(Object_isShared), /*P=*/10,
	DATA_METHOD0, CLASS_Object, MN_setShared, 0, _DATA(Object_setShared), /*P=*/98,
	...
	DATA_METHOD0, CLASS_OutputStream, MN_setAutoFlush, 0, _DATA(OutputStream_setAutoFlush), /*P=*/98,
	DATA_METHOD0, CLASS_OutputStream, MN_isStoringBuffer, 0, _DATA(OutputStream_isStoringBuffer), /*P=*/10,
	DATA_METHOD0, CLASS_OutputStream, MN_setStoringBuffer, 0, _DATA(OutputStream_setStoringBuffer), /*P=*/98,
	DATA_METHOD0, CLASS_Context, MN_isStrict, 0, _DATA(Context_isStrict), /*P=*/10,
	DATA_METHOD0, CLASS_Context, MN_setStrict, 0, _DATA(Context_setStrict), /*P=*/98,
	DATA_METHOD0, CLASS_Context, MN_isDebug, 0, _DATA(Context_isDebug), /*P=*/10,
	DATA_METHOD0, CLASS_Context, MN_setDebug, 0, _DATA(Context_setDebug), /*P=*/98,
	DATA_METHOD0, CLASS_Context, MN_isVerbose, 0, _DATA(Context_isVerbose), /*P=*/10,
	DATA_METHOD0, CLASS_Context, MN_setVerbose, 0, _DATA(Context_setVerbose), /*P=*/98,
