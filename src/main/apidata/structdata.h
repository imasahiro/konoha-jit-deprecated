...
static knh_data_t ClassData0[] = {
	...
	DATA_CLASS, _DATA("konoha.Int"), FLAG_Int, CLASS_Int, CLASS_Number, 21 + 10 /*1*/,
	DATA_CLASS, _DATA("konoha.Float"), FLAG_Float, CLASS_Float, CLASS_Number, 16 + 7 /*1*/,
	DATA_CLASS, _DATA("konoha.String"), FLAG_String, CLASS_String, CLASS_Object, 27 + 3 /*4*/,
...
static knh_data_t ParamArrayData0[] = {
	...
	DATA_PARAM/*20*/, 0, 1, 1, TYPE_String, FN_fmt, TYPE_String, FN_return,
	...
	DATA_PARAM/*45*/, 0, 1, 1, TYPE_Any, FN_x, TYPE_Any, FN_return,
	DATA_PARAM/*46*/, 0, 1, 1, TYPE_Class, FN_c, TYPE_Boolean, FN_return,
	DATA_PARAM/*47*/, 0, 1, 1, TYPE_Any, FN_value, TYPE_Boolean, FN_return,
	...
	DATA_PARAM/*51*/, 0, 1, 1, TYPE_Any, FN_v, TYPE_Boolean, FN_return,
	...
	DATA_PARAM/*56*/, 0, 1, 1, TYPE_Any, FN_value, TYPE_Any, FN_return,
	DATA_PARAM/*57*/, 0, 0, 1, TYPE_Any, FN_return,
	...
	DATA_PARAM/*65*/, 0, 0, 1, TYPE_T1, FN_return,
	DATA_PARAM/*66*/, 0, 2, 1, TYPE_String, FN_urn, TYPE_String, FN_mode, TYPE_InputStream, FN_return,
	DATA_PARAM/*67*/, 0, 3, 1, TYPE_Bytes, FN_buf, TYPE_Int, FN_offset, TYPE_Int, FN_length, TYPE_Int, FN_return,
	DATA_PARAM/*68*/, 0, 1, 1, TYPE_StringDecoder, FN_c, TYPE_StringDecoder, FN_return,
	DATA_PARAM/*69*/, 0, 2, 1, TYPE_String, FN_urn, TYPE_String, FN_mode, TYPE_OutputStream, FN_return,
	DATA_PARAM/*70*/, 0, 1, 0, TYPE_Int, FN_ch,
	DATA_PARAM/*71*/, FLAG_ParamArray_VARGs, 1, 0, TYPE_Object, FN_value,
	DATA_PARAM/*72*/, FLAG_ParamArray_VARGs, 1, 0, TYPE_Any, FN_value,
	DATA_PARAM/*73*/, FLAG_ParamArray_VARGs, 1, 0, TYPE_Object, FN_data,
	DATA_PARAM/*74*/, 0, 1, 1, TYPE_StringEncoder, FN_c, TYPE_StringEncoder, FN_return,
	DATA_PARAM/*75*/, 0, 1, 1, TYPE_Class, FN_c, TYPE_Any, FN_return,
	DATA_PARAM/*76*/, FLAG_ParamArray_VARGs, 1, 1, TYPE_Object, FN_value, TYPE_String, FN_return,
	DATA_PARAM/*77*/, 0, 1, 1, TYPE_Any, FN_value, TYPE_String, FN_return,
	DATA_PARAM/*78*/, 0, 1, 1, TYPE_Regex, FN_re, TYPE_Int, FN_return,
	DATA_PARAM/*79*/, 0, 2, 1, TYPE_Regex, FN_re, TYPE_String, FN_s, TYPE_String, FN_return,
	DATA_PARAM/*80*/, 0, 1, 1, TYPE_Regex, FN_re, TYPE_StringARRAY, FN_return,
	DATA_PARAM/*81*/, 0, 1, 1, TYPE_Converter, FN_enc, TYPE_Bytes, FN_return,
	DATA_PARAM/*82*/, 0, 1, 1, TYPE_StringEncoder, FN_enc, TYPE_Bytes, FN_return,
	DATA_PARAM/*83*/, 0, 1, 1, TYPE_StringDecoder, FN_c, TYPE_String, FN_return,
	DATA_PARAM/*84*/, 0, 1, 1, TYPE_StringConverter, FN_c, TYPE_String, FN_return,
	DATA_PARAM/*85*/, 0, 1, 1, TYPE_Regex, FN_re, TYPE_Boolean, FN_return,
	DATA_PARAM/*86*/, 0, 0, 1, TYPE_InputStream, FN_return,
	DATA_PARAM/*87*/, 0, 0, 1, TYPE_OutputStream, FN_return,
	DATA_PARAM/*88*/, 0, 1, 1, TYPE_String, FN_key, TYPE_Any, FN_return,
	DATA_PARAM/*89*/, 0, 2, 1, TYPE_String, FN_key, TYPE_Any, FN_value, TYPE_Any, FN_return,
	DATA_PARAM/*90*/, 0, 1, 1, TYPE_String, FN_key, TYPE_StringARRAY, FN_return,
	DATA_PARAM/*91*/, 0, 1, 0, TYPE_Int, FN_status,
	DATA_PARAM/*92*/, 0, 1, 1, TYPE_InputStream, FN_in, TYPE_InputStream, FN_return,
	DATA_PARAM/*93*/, 0, 1, 1, TYPE_OutputStream, FN_out, TYPE_OutputStream, FN_return,
	DATA_PARAM/*94*/, 0, 1, 1, TYPE_Any, FN_msg, TYPE_Boolean, FN_return,
	DATA_PARAM/*95*/, 0, 2, 1, TYPE_String, FN_name, TYPE_Object, FN_value, TYPE_Any, FN_return,
	DATA_PARAM/*96*/, 0, 1, 1, TYPE_Boolean, FN_flag, TYPE_Boolean, FN_return,
	0
};
#define K_PARAM0_SIZE                   97
...
static knh_data_t APIData0[] = {
	...
	DATA_METHOD0, CLASS_Int, MN_format, FLAG_Method_Const, _DATA(Int_format), /*P=*/20,
	DATA_METHOD0, CLASS_Float, MN_format, FLAG_Method_Const, _DATA(Float_format), /*P=*/20,
	DATA_METHOD0, CLASS_String, MN_format, FLAG_Method_Const, _DATA(String_format), /*P=*/20,
	...
	DATA_METHOD0, CLASS_Exception, MN__k, 0, _DATA(Exception__k), /*P=*/0,
	...
	DATA_METHOD0, CLASS_String, MN__data, 0, _DATA(String__data), /*P=*/0,
	DATA_METHOD0, CLASS_Bytes, MN__data, 0, _DATA(Bytes__data), /*P=*/0,
	DATA_METHOD0, CLASS_Array, MN__data, 0, _DATA(Array__data), /*P=*/0,
	DATA_METHOD0, CLASS_Map, MN__data, 0, _DATA(Map__data), /*P=*/0,
	DATA_METHOD0, CLASS_Exception, MN__data, 0, _DATA(Exception__data), /*P=*/0,
	...
	DATA_METHOD0, CLASS_Func, MN_invoke, FLAG_Method_Hidden|FLAG_Method_Private, _DATA(Func_invoke), /*P=*/45,
	...
	DATA_METHOD0, CLASS_Range, MN_opHAS, 0, _DATA(Range_opHAS), /*P=*/51,
	DATA_METHOD0, CLASS_Range, MN_opCASE, 0, _DATA(Range_opHAS), /*P=*/51,
	DATA_METHOD0, CLASS_Array, MN_opHAS, 0, _DATA(Array_opHAS), /*P=*/51,
	DATA_METHOD0, CLASS_Array, MN_opCASE, 0, _DATA(Array_opHAS), /*P=*/51,
	DATA_METHOD0, CLASS_Tuple, MN_opHAS, 0, _DATA(Tuple_opHAS), /*P=*/51,
	DATA_METHOD0, CLASS_Tuple, MN_opCASE, 0, _DATA(Tuple_opHAS), /*P=*/51,
	DATA_METHOD0, CLASS_Object, MN_opCASE, FLAG_Method_Const, _DATA(Object_opCASE), /*P=*/51,
	DATA_METHOD0, CLASS_Int, MN_opCASE, FLAG_Method_Const, _DATA(Int_opCASE), /*P=*/51,
	DATA_METHOD0, CLASS_Float, MN_opCASE, FLAG_Method_Const, _DATA(Float_opCASE), /*P=*/51,
	...
	DATA_METHOD0, CLASS_Any, MN_opADD, 0, _DATA(Any_opADD), /*P=*/56,
	DATA_METHOD0, CLASS_Any, MN_opSUB, 0, _DATA(Any_opADD), /*P=*/56,
	DATA_METHOD0, CLASS_Any, MN_opMUL, 0, _DATA(Any_opADD), /*P=*/56,
	DATA_METHOD0, CLASS_Any, MN_opDIV, 0, _DATA(Any_opADD), /*P=*/56,
	DATA_METHOD0, CLASS_Any, MN_opMOD, 0, _DATA(Any_opADD), /*P=*/56,
	DATA_METHOD0, CLASS_Any, MN_opNEG, 0, _DATA(Any_opADD), /*P=*/57,
	...
	DATA_METHOD0, CLASS_Tuple, MN_opEXPAND, 0, _DATA(Tuple_opEXPAND), /*P=*/57,
	DATA_METHOD0, CLASS_Array, MN_opEXPAND, 0, _DATA(Array_opEXPAND), /*P=*/65,
	DATA_METHOD0, CLASS_InputStream, MN_new, 0, _DATA(InputStream_new), /*P=*/66,
	DATA_METHOD0, CLASS_InputStream, MN_getChar, 0, _DATA(InputStream_getChar), /*P=*/9,
	DATA_METHOD0, CLASS_InputStream, MN_read, 0, _DATA(InputStream_read), /*P=*/67,
	...
	DATA_METHOD0, CLASS_InputStream, MN_setCharset, 0, _DATA(InputStream_setCharset), /*P=*/68,
	DATA_METHOD0, CLASS_InputStream, MN_readLine, 0, _DATA(InputStream_readLine), /*P=*/43,
	DATA_METHOD0, CLASS_OutputStream, MN_new, 0, _DATA(OutputStream_new), /*P=*/69,
	DATA_METHOD0, CLASS_OutputStream, MN_writeChar, 0, _DATA(OutputStream_writeChar), /*P=*/70,
	...
	DATA_METHOD0, CLASS_OutputStream, MN_print, 0, _DATA(OutputStream_print), /*P=*/71,
	DATA_METHOD0, CLASS_OutputStream, MN_opSEND, 0, _DATA(OutputStream_opSEND), /*P=*/71,
	DATA_METHOD0, CLASS_OutputStream, MN_println, 0, _DATA(OutputStream_println), /*P=*/72,
	DATA_METHOD0, CLASS_OutputStream, MN_writeData, 0, _DATA(OutputStream_writeData), /*P=*/73,
	...
	DATA_METHOD0, CLASS_OutputStream, MN_setCharset, 0, _DATA(OutputStream_setCharaset), /*P=*/74,
	DATA_METHOD0, CLASS_String, MN_opEXISTS, FLAG_Method_Const, _DATA(String_opEXISTS), /*P=*/10,
	DATA_METHOD0, CLASS_String, MN_opPATH, FLAG_Method_Hidden|FLAG_Method_Private, _DATA(String_opPATH), /*P=*/75,
	...
	DATA_METHOD0, CLASS_String, MN_concat, FLAG_Method_Const, _DATA(String_concat), /*P=*/76,
	DATA_METHOD0, CLASS_String, MN_opADD, FLAG_Method_Const, _DATA(String_concat), /*P=*/77,
	DATA_METHOD0, CLASS_String, MN_indexOf, FLAG_Method_Const, _DATA(String_indexOf), /*P=*/78,
	DATA_METHOD0, CLASS_String, MN_lastIndexOf, FLAG_Method_Const, _DATA(String_lastIndexOf), /*P=*/78,
	DATA_METHOD0, CLASS_String, MN_replace, FLAG_Method_Const, _DATA(String_replace), /*P=*/79,
	DATA_METHOD0, CLASS_String, MN_split, FLAG_Method_Const, _DATA(String_split), /*P=*/80,
	DATA_METHOD0, CLASS_Bytes, MN_, FLAG_Method_Const, _DATA(Bytes_convert), /*P=*/81,
	DATA_METHOD0, CLASS_String, MN_encode, FLAG_Method_Const, _DATA(String_encode), /*P=*/82,
	DATA_METHOD0, CLASS_Bytes, MN_decode, FLAG_Method_Const, _DATA(Bytes_toString), /*P=*/83,
	DATA_METHOD0, CLASS_String, MN_, FLAG_Method_Const, _DATA(String_convert), /*P=*/84,
	DATA_METHOD0, CLASS_String, MN_convert, FLAG_Method_Const, _DATA(String_convert), /*P=*/84,
	DATA_METHOD0, CLASS_String, MN_trim, FLAG_Method_Const, _DATA(String_trim), /*P=*/43,
	DATA_METHOD0, CLASS_String, MN_opCASE, 0, _DATA(String_opCASE), /*P=*/85,
	DATA_METHOD0, CLASS_Regex, MN_opCASE, 0, _DATA(Regex_opCASE), /*P=*/50,
	DATA_METHOD0, CLASS_System, MN_getIn, FLAG_Method_Static, _DATA(System_getIn), /*P=*/86,
	DATA_METHOD0, CLASS_System, MN_getOut, FLAG_Method_Static, _DATA(System_getOut), /*P=*/87,
	DATA_METHOD0, CLASS_System, MN_getErr, FLAG_Method_Static, _DATA(System_getErr), /*P=*/87,
	DATA_METHOD0, CLASS_System, MN_getProperty, FLAG_Method_Static, _DATA(System_getProperty), /*P=*/88,
	DATA_METHOD0, CLASS_System, MN_setProperty, FLAG_Method_Static, _DATA(System_setProperty), /*P=*/89,
	DATA_METHOD0, CLASS_System, MN_listProperties, FLAG_Method_Hidden, _DATA(System_listProperties), /*P=*/90,
	DATA_METHOD0, CLASS_System, MN_gc, FLAG_Method_Static, _DATA(System_gc), /*P=*/0,
	DATA_METHOD0, CLASS_System, MN_push, FLAG_Method_Static|FLAG_Method_Hidden, _DATA(System_push), /*P=*/71,
	DATA_METHOD0, CLASS_System, MN_getTime, 0, _DATA(System_getTime), /*P=*/9,
	DATA_METHOD0, CLASS_System, MN_exit, FLAG_Method_Static, _DATA(System_exit), /*P=*/91,
	DATA_METHOD0, CLASS_Context, MN_setIn, FLAG_Method_Static, _DATA(Context_setIn), /*P=*/92,
	DATA_METHOD0, CLASS_Context, MN_setOut, FLAG_Method_Static, _DATA(Context_setOut), /*P=*/93,
	DATA_METHOD0, CLASS_Context, MN_setErr, FLAG_Method_Static, _DATA(Context_setErr), /*P=*/93,
	DATA_METHOD0, CLASS_Exception, MN_opOF, 0, _DATA(Exception_opOF), /*P=*/94,
	DATA_METHOD0, CLASS_NameSpace, MN_setConst, FLAG_Method_Const|FLAG_Method_Hidden, _DATA(NameSpace_setConst), /*P=*/95,
	DATA_METHOD0, CLASS_Class, MN_setConst, FLAG_Method_Const|FLAG_Method_Hidden, _DATA(Class_setConst), /*P=*/95,
	...
	DATA_METHOD0, CLASS_Object, MN_setModified, 0, _DATA(Object_setModified), /*P=*/96,
	DATA_METHOD0, CLASS_Object, MN_isShared, 0, _DATA(Object_isShared), /*P=*/10,
	DATA_METHOD0, CLASS_Object, MN_setShared, 0, _DATA(Object_setShared), /*P=*/96,
	...
	DATA_METHOD0, CLASS_OutputStream, MN_setAutoFlush, 0, _DATA(OutputStream_setAutoFlush), /*P=*/96,
	DATA_METHOD0, CLASS_OutputStream, MN_isStoringBuffer, 0, _DATA(OutputStream_isStoringBuffer), /*P=*/10,
	DATA_METHOD0, CLASS_OutputStream, MN_setStoringBuffer, 0, _DATA(OutputStream_setStoringBuffer), /*P=*/96,
	DATA_METHOD0, CLASS_Context, MN_isStrict, 0, _DATA(Context_isStrict), /*P=*/10,
	DATA_METHOD0, CLASS_Context, MN_setStrict, 0, _DATA(Context_setStrict), /*P=*/96,
	DATA_METHOD0, CLASS_Context, MN_isDebug, 0, _DATA(Context_isDebug), /*P=*/10,
	DATA_METHOD0, CLASS_Context, MN_setDebug, 0, _DATA(Context_setDebug), /*P=*/96,
	DATA_METHOD0, CLASS_Context, MN_isVerbose, 0, _DATA(Context_isVerbose), /*P=*/10,
	DATA_METHOD0, CLASS_Context, MN_setVerbose, 0, _DATA(Context_setVerbose), /*P=*/96,
