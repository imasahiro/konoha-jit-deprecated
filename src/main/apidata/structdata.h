...
static knh_data_t ClassData0[] = {
	...
	DATA_CLASS, _DATA("konoha.Float"), FLAG_Float, CLASS_Float, CLASS_Number, 16 + 5 /*1*/,
	DATA_CLASS, _DATA("konoha.String"), FLAG_String, CLASS_String, CLASS_Object, 25 + 3 /*4*/,
...
static knh_data_t ParamArrayData0[] = {
	...
	DATA_PARAM/*72*/, FLAG_ParamArray_VARGs, 1, 0, TYPE_String, FN_s,
	...
	DATA_PARAM/*80*/, 0, 1, 1, TYPE_Converter, FN_enc, TYPE_Bytes, FN_return,
	DATA_PARAM/*81*/, 0, 1, 1, TYPE_StringEncoder, FN_enc, TYPE_Bytes, FN_return,
	DATA_PARAM/*82*/, 0, 1, 1, TYPE_StringDecoder, FN_c, TYPE_String, FN_return,
	DATA_PARAM/*83*/, 0, 1, 1, TYPE_StringConverter, FN_c, TYPE_String, FN_return,
	DATA_PARAM/*84*/, 0, 1, 1, TYPE_Regex, FN_re, TYPE_Boolean, FN_return,
	DATA_PARAM/*85*/, 0, 0, 1, TYPE_InputStream, FN_return,
	DATA_PARAM/*86*/, 0, 0, 1, TYPE_OutputStream, FN_return,
	DATA_PARAM/*87*/, 0, 1, 1, TYPE_String, FN_key, TYPE_Any, FN_return,
	DATA_PARAM/*88*/, 0, 2, 1, TYPE_String, FN_key, TYPE_Any, FN_value, TYPE_Any, FN_return,
	DATA_PARAM/*89*/, 0, 1, 1, TYPE_String, FN_key, TYPE_StringARRAY, FN_return,
	DATA_PARAM/*90*/, 0, 1, 0, TYPE_Int, FN_status,
	DATA_PARAM/*91*/, 0, 1, 1, TYPE_InputStream, FN_in, TYPE_InputStream, FN_return,
	DATA_PARAM/*92*/, 0, 1, 1, TYPE_OutputStream, FN_out, TYPE_OutputStream, FN_return,
	DATA_PARAM/*93*/, 0, 1, 1, TYPE_Any, FN_msg, TYPE_Boolean, FN_return,
	DATA_PARAM/*94*/, 0, 2, 1, TYPE_String, FN_name, TYPE_Object, FN_value, TYPE_Any, FN_return,
	DATA_PARAM/*95*/, 0, 1, 1, TYPE_Boolean, FN_flag, TYPE_Boolean, FN_return,
	0
};
#define K_PARAM0_SIZE                   96
...
static knh_data_t APIData0[] = {
	...
	DATA_METHOD0, CLASS_Tuple, MN_getSize, 0, _DATA(Tuple_getSize), /*P=*/10,
	...
	DATA_METHOD0, CLASS_String, MN_opEXISTS, FLAG_Method_Const, _DATA(String_opEXISTS), /*P=*/11,
	DATA_METHOD0, CLASS_String, MN_path, FLAG_Method_Hidden|FLAG_Method_Private, _DATA(String_path), /*P=*/76,
	...
	DATA_METHOD0, CLASS_String, MN_indexOf, FLAG_Method_Const, _DATA(String_indexOf), /*P=*/77,
	DATA_METHOD0, CLASS_String, MN_lastIndexOf, FLAG_Method_Const, _DATA(String_lastIndexOf), /*P=*/77,
	DATA_METHOD0, CLASS_String, MN_replace, FLAG_Method_Const, _DATA(String_replace), /*P=*/78,
	DATA_METHOD0, CLASS_String, MN_split, FLAG_Method_Const, _DATA(String_split), /*P=*/79,
	DATA_METHOD0, CLASS_Bytes, MN_, FLAG_Method_Const, _DATA(Bytes_convert), /*P=*/80,
	DATA_METHOD0, CLASS_String, MN_encode, FLAG_Method_Const, _DATA(String_encode), /*P=*/81,
	DATA_METHOD0, CLASS_Bytes, MN_decode, FLAG_Method_Const, _DATA(Bytes_toString), /*P=*/82,
	DATA_METHOD0, CLASS_String, MN_, FLAG_Method_Const, _DATA(String_convert), /*P=*/83,
	DATA_METHOD0, CLASS_String, MN_convert, FLAG_Method_Const, _DATA(String_convert), /*P=*/83,
	DATA_METHOD0, CLASS_String, MN_trim, FLAG_Method_Const, _DATA(String_trim), /*P=*/44,
	DATA_METHOD0, CLASS_String, MN_opCASE, 0, _DATA(String_opCASE), /*P=*/84,
	DATA_METHOD0, CLASS_Regex, MN_opCASE, 0, _DATA(Regex_opCASE), /*P=*/50,
	DATA_METHOD0, CLASS_System, MN_getIn, FLAG_Method_Static, _DATA(System_getIn), /*P=*/85,
	DATA_METHOD0, CLASS_System, MN_getOut, FLAG_Method_Static, _DATA(System_getOut), /*P=*/86,
	DATA_METHOD0, CLASS_System, MN_getErr, FLAG_Method_Static, _DATA(System_getErr), /*P=*/86,
	DATA_METHOD0, CLASS_System, MN_getProperty, FLAG_Method_Static, _DATA(System_getProperty), /*P=*/87,
	DATA_METHOD0, CLASS_System, MN_setProperty, FLAG_Method_Static, _DATA(System_setProperty), /*P=*/88,
	DATA_METHOD0, CLASS_System, MN_listProperties, FLAG_Method_Hidden, _DATA(System_listProperties), /*P=*/89,
	...
	DATA_METHOD0, CLASS_System, MN_exit, FLAG_Method_Static, _DATA(System_exit), /*P=*/90,
	DATA_METHOD0, CLASS_Context, MN_setIn, FLAG_Method_Static, _DATA(Context_setIn), /*P=*/91,
	DATA_METHOD0, CLASS_Context, MN_setOut, FLAG_Method_Static, _DATA(Context_setOut), /*P=*/92,
	DATA_METHOD0, CLASS_Context, MN_setErr, FLAG_Method_Static, _DATA(Context_setErr), /*P=*/92,
