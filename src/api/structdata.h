...
static knh_MethodFieldData_t MethodFieldData[] = {
	...
	{119, 2, NNTYPE_Socket, NNTYPE_String, FIELDN_host, NNTYPE_Int, FIELDN_port},
	{120, 0, NNTYPE_InputStream},
	{121, 0, NNTYPE_OutputStream},
	{122, 1, NNTYPE_Bytes, NATYPE_String, FIELDN_enc},
	{123, 1, NNTYPE_Int, NNTYPE_String, FIELDN_s},
	{124, 1, NNTYPE_String, NATYPE_Any, FIELDN_value},
	{125, 1, TYPE_PairSS, NNTYPE_String, FIELDN_s},
	{126, 2, NNTYPE_String, NNTYPE_String, FIELDN_s, NNTYPE_String, FIELDN_newone},
	{127, 2, TYPE_String_Ary, TYPE_String, FIELDN_delim, TYPE_Int, FIELDN_isTrim},
	{128, 1, NNTYPE_Boolean, NNTYPE_Regex, FIELDN_re},
	{129, 1, TYPE_String_Ary, TYPE_Regex, FIELDN_pattern},
	{130, 1, NATYPE_Any, NNTYPE_String, FIELDN_key},
	{131, 2, TYPE_void, NNTYPE_String, FIELDN_key, NATYPE_Any, FIELDN_value},
	{132, 1, TYPE_Int, TYPE_String, FIELDN_cmd},
	{133, 2, NNTYPE_Boolean, NNTYPE_String, FIELDN_lib, NATYPE_String, FIELDN_func},
	{134, 1, TYPE_void, TYPE_Int, FIELDN_status},
	{135, 1, TYPE_String_Ary, NATYPE_String, FIELDN_path},
	{136, 1, NNTYPE_Boolean, NNTYPE_String, FIELDN_path},
	{137, 2, NNTYPE_Boolean, TYPE_String, FIELDN_path, TYPE_String, FIELDN_newpath},
	{138, 1, TYPE_Any, NNTYPE_String, FIELDN_key},
	{139, 1, TYPE_String_Ary, TYPE_String, FIELDN_key},
	{140, 1, TYPE_void, NATYPE_InputStream, FIELDN_in},
	{141, 1, TYPE_void, NATYPE_OutputStream, FIELDN_out},
	{142, 1, NNTYPE_Boolean, TYPE_String, FIELDN_msg},
	{143, 2, TYPE_void, NNTYPE_String, FIELDN_name, TYPE_Any, FIELDN_value},
	{144, 1, TYPE_void, NNTYPE_Boolean, FIELDN_flag},
	{-1}
};
#define KNH_TMETHODFIELD_SIZE           145
...
static knh_MethodData_t MethodData[] = {
	...
	{Socket_new, 0, CLASS_Socket, METHODN_new, 0, 119, NULL},
	{Socket_getInputStream, 0, CLASS_Socket, METHODN_getInputStream, 0, 120, NULL},
	{Socket_getOutputStream, 0, CLASS_Socket, METHODN_getOutputStream, 0, 121, NULL},
	{Socket_close, 0, CLASS_Socket, METHODN_close, 0, 0, NULL},
	{Socket_isClosed, 0, CLASS_Socket, METHODN_isClosed, 0, 27, NULL},
	{String_getBytes, FLAG_Method_Const, CLASS_String, METHODN_getBytes, 0, 122, NULL},
	...
	{String_indexOf, FLAG_Method_Const, CLASS_String, METHODN_indexOf, 0, 123, NULL},
	{String_indexOf__IgnoreCase, FLAG_Method_Const, CLASS_String, METHODN_indexOf__IgnoreCase, 0, 123, NULL},
	{String_lastIndexOf, FLAG_Method_Const, CLASS_String, METHODN_lastIndexOf, 0, 123, NULL},
	{String_lastIndexOf__IgnoreCase, FLAG_Method_Const, CLASS_String, METHODN_lastIndexOf__IgnoreCase, 0, 123, NULL},
	{String_concat, FLAG_Method_Const|FLAG_Method_VarArgs|FLAG_Method_NullBase, CLASS_String, METHODN_concat, 0, 124, NULL},
	{String_times, FLAG_Method_Const, CLASS_String, METHODN_times, 0, 28, NULL},
	{String_twofold, FLAG_Method_Const, CLASS_String, METHODN_twofold, 0, 125, NULL},
	{String_format, FLAG_Method_VarArgs, CLASS_String, METHODN_format, 0, 124, NULL},
	{String_replace, FLAG_Method_Const, CLASS_String, METHODN_replace, 0, 126, NULL},
	...
	{String_split, FLAG_Method_Const, CLASS_String, METHODN_split, 0, 127, NULL},
	{String_opMatch, 0, CLASS_String, METHODN_opMatch, 0, 128, NULL},
	{Regex_opMatch, 0, CLASS_Regex, METHODN_opMatch, 0, 84, NULL},
	{String_match, FLAG_Method_Const, CLASS_String, METHODN_match, 0, 129, NULL},
	{System_getIn, FLAG_Method_Static, CLASS_System, METHODN_getIn, 0, 120, NULL},
	{System_getOut, FLAG_Method_Static, CLASS_System, METHODN_getOut, 0, 121, NULL},
	{System_getErr, FLAG_Method_Static, CLASS_System, METHODN_getErr, 0, 121, NULL},
	{System_getProperty, FLAG_Method_Static, CLASS_System, METHODN_getProperty, 0, 130, NULL},
	{System_setProperty, FLAG_Method_Static, CLASS_System, METHODN_setProperty, 0, 131, NULL},
	{System_gc, FLAG_Method_Static, CLASS_System, METHODN_gc, 0, 0, NULL},
	{Script_system, 0, CLASS_Script, METHODN_system, 0, 132, NULL},
	{Script_system, 0, CLASS_Script, METHODN_sudo, 0, 132, NULL},
	{System_hasLib, FLAG_Method_Static, CLASS_System, METHODN_hasLib, 0, 133, NULL},
	{System_exit, FLAG_Method_Static, CLASS_System, METHODN_exit, 0, 134, NULL},
	{System_listDir, 0, CLASS_System, METHODN_listDir, 0, 135, NULL},
	{System_hasDir, 0, CLASS_System, METHODN_hasDir, 0, 136, NULL},
	{System_hasFile, 0, CLASS_System, METHODN_hasFile, 0, 136, NULL},
	{System_mkdir, 0, CLASS_System, METHODN_mkdir, 0, 136, NULL},
	{System_unlink, 0, CLASS_System, METHODN_unlink, 0, 136, NULL},
	{System_rename, 0, CLASS_System, METHODN_rename, 0, 137, NULL},
	{Context_getProperty, FLAG_Method_Static, CLASS_Context, METHODN_getProperty, 0, 138, NULL},
	{Context_setProperty, FLAG_Method_Static, CLASS_Context, METHODN_setProperty, 0, 131, NULL},
	{Context_setEncoding, FLAG_Method_Static, CLASS_Context, METHODN_setEncoding, 0, 113, NULL},
	{Context_listProperties, FLAG_Method_Hidden, CLASS_Context, METHODN_listProperties, 0, 139, NULL},
	{Context_setIn, FLAG_Method_Static, CLASS_Context, METHODN_setIn, 0, 140, NULL},
	{Context_setOut, FLAG_Method_Static, CLASS_Context, METHODN_setOut, 0, 141, NULL},
	{Context_setErr, FLAG_Method_Static, CLASS_Context, METHODN_setErr, 0, 141, NULL},
	{knh_fmethod_formatter, 0, CLASS_Context, METHODN__dump, 0, 22, (void*)knh_Context__dump},
	{Exception_opIsa, 0, CLASS_Exception, METHODN_opIsa, 0, 142, NULL},
	{NameSpace_setConst, FLAG_Method_Const|FLAG_Method_Hidden, CLASS_NameSpace, METHODN_setConst, 0, 143, NULL},
	...
	{Object_setModified, 0, CLASS_Object, METHODN_setModified, 0, 144, NULL},
	{Object_isShared, 0, CLASS_Object, METHODN_isShared, 0, 27, NULL},
	{Object_setShared, 0, CLASS_Object, METHODN_setShared, 0, 144, NULL},
	...
	{OutputStream_setAutoFlush, 0, CLASS_OutputStream, METHODN_setAutoFlush, 0, 144, NULL},
	{OutputStream_isStoringBuffer, 0, CLASS_OutputStream, METHODN_isStoringBuffer, 0, 27, NULL},
	{OutputStream_setStoringBuffer, 0, CLASS_OutputStream, METHODN_setStoringBuffer, 0, 144, NULL},
	...
	{Context_setStrict, 0, CLASS_Context, METHODN_setStrict, 0, 144, NULL},
	{Context_isDebug, 0, CLASS_Context, METHODN_isDebug, 0, 27, NULL},
	{Context_setDebug, 0, CLASS_Context, METHODN_setDebug, 0, 144, NULL},
	{Context_isVerbose, 0, CLASS_Context, METHODN_isVerbose, 0, 27, NULL},
	{Context_setVerbose, 0, CLASS_Context, METHODN_setVerbose, 0, 144, NULL},
