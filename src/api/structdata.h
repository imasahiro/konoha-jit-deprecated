...
static knh_ClassData_t ClassData[] = {
	...
	{"System", CLASS_System, FLAG_System, 
	   CLASS_System, CLASS_Object, 18, 0, 0,
	   TYPE_void, TYPE_void, TYPE_void, TYPE_void},
...
static knh_MethodFieldData_t MethodFieldData[] = {
	...
	{57, 1, NNTYPE_This, TYPE_Int, FIELDN_init},
	...
	{78, 0, NNTYPE_String},
	{79, 0, NNTYPE_Array},
	{80, 1, TYPE_void, TYPE_Int, FIELDN_trace},
	{81, 3, TYPE_T0, TYPE_T1, FIELDN_x, TYPE_T2, FIELDN_y, TYPE_T3, FIELDN_z},
	{82, 1, TYPE_Boolean, TYPE_Class, FIELDN_c},
	{83, 1, NNTYPE_Boolean, TYPE_Any, FIELDN_value},
	{84, 1, NNTYPE_Boolean, NNTYPE_Int, FIELDN_value},
	{85, 1, NNTYPE_Boolean, TYPE_Float, FIELDN_value},
	{86, 1, NNTYPE_Boolean, NNTYPE_String, FIELDN_s},
	{87, 1, NNTYPE_Boolean, TYPE_Any, FIELDN_v},
	{88, 1, NNTYPE_Boolean, TYPE_Any, FIELDN_o},
	{89, 1, NNTYPE_Int, NNTYPE_Int, FIELDN_v},
	{90, 1, NNTYPE_Int, NNTYPE_Int, FIELDN_n},
	{91, 1, NNTYPE_Float, NNTYPE_Float, FIELDN_v},
	{92, 1, NNTYPE_Float, NNTYPE_Float, FIELDN_n},
	{93, 1, NNTYPE_String, TYPE_Any, FIELDN_value},
	{94, 1, NNTYPE_String, NNTYPE_String, FIELDN_s},
	{95, 1, TYPE_Any, TYPE_Any, FIELDN_value},
	{96, 0, TYPE_Any},
	{97, 2, TYPE_void, NNTYPE_Int, FIELDN_n, NNTYPE_Int, FIELDN_c},
	{98, 1, TYPE_void, NNTYPE_Int, FIELDN_c},
	{99, 1, NNTYPE_T1, NNTYPE_Int, FIELDN_n},
	{100, 1, TYPE_Any, NNTYPE_Int, FIELDN_n},
	{101, 2, TYPE_void, NNTYPE_Int, FIELDN_n, NNTYPE_T1, FIELDN_v},
	{102, 2, TYPE_void, NNTYPE_Int, FIELDN_n, NNTYPE_Int, FIELDN_v},
	{103, 2, TYPE_void, NNTYPE_Int, FIELDN_n, NNTYPE_Float, FIELDN_v},
	{104, 1, TYPE_void, TYPE_T1, FIELDN_v},
	{105, 1, TYPE_void, NNTYPE_Int, FIELDN_v},
	{106, 1, TYPE_void, NNTYPE_Float, FIELDN_v},
	...
	{130, 2, TYPE_String_Ary, TYPE_String, FIELDN_delim, TYPE_Int, FIELDN_isTrim},
	...
	{134, 2, TYPE_void, NNTYPE_String, FIELDN_key, NATYPE_Any, FIELDN_value},
	...
	{142, 1, TYPE_Any, NNTYPE_String, FIELDN_key},
	{143, 1, TYPE_String_Ary, TYPE_String, FIELDN_key},
	{144, 1, TYPE_void, NATYPE_InputStream, FIELDN_in},
	{145, 1, TYPE_void, NATYPE_OutputStream, FIELDN_out},
	{146, 1, NNTYPE_Boolean, TYPE_Any, FIELDN_msg},
	{147, 2, TYPE_void, NNTYPE_String, FIELDN_name, TYPE_Any, FIELDN_value},
	{148, 1, TYPE_void, NNTYPE_Boolean, FIELDN_flag},
	{-1}
};
...
static knh_MethodData_t MethodData[] = {
	...
	{Method_setTrace, FLAG_Method_Const, CLASS_Method, METHODN_setTrace, 0, 80, NULL},
	{Closure_invoke, FLAG_Method_VarArgs, CLASS_Closure, METHODN_invoke, 0, 81, NULL},
	...
	{Object_opInstanceof, FLAG_Method_NullBase, CLASS_Object, METHODN_opInstanceof, 0, 82, NULL},
	{Object_opEq, FLAG_Method_Const|FLAG_Method_NullBase, CLASS_Object, METHODN_opEq, 0, 83, NULL},
	{Object_opNeq, FLAG_Method_Const|FLAG_Method_NullBase, CLASS_Object, METHODN_opNeq, 0, 83, NULL},
	{Object_opLt, FLAG_Method_Const|FLAG_Method_NullBase, CLASS_Object, METHODN_opLt, 0, 83, NULL},
	{Object_opLte, FLAG_Method_Const|FLAG_Method_NullBase, CLASS_Object, METHODN_opLte, 0, 83, NULL},
	{Object_opGt, FLAG_Method_Const|FLAG_Method_NullBase, CLASS_Object, METHODN_opGt, 0, 83, NULL},
	{Object_opGte, FLAG_Method_Const|FLAG_Method_NullBase, CLASS_Object, METHODN_opGte, 0, 83, NULL},
	{Int_opEq, FLAG_Method_Const, CLASS_Int, METHODN_opEq, 0, 84, NULL},
	{Int_opNeq, FLAG_Method_Const, CLASS_Int, METHODN_opNeq, 0, 84, NULL},
	{Int_opLt, FLAG_Method_Const, CLASS_Int, METHODN_opLt, 0, 84, NULL},
	{Int_opLte, FLAG_Method_Const, CLASS_Int, METHODN_opLte, 0, 84, NULL},
	{Int_opGt, FLAG_Method_Const, CLASS_Int, METHODN_opGt, 0, 84, NULL},
	{Int_opGte, FLAG_Method_Const, CLASS_Int, METHODN_opGte, 0, 84, NULL},
	{Float_opEq, FLAG_Method_Const|FLAG_Method_NullBase, CLASS_Float, METHODN_opEq, 0, 85, NULL},
	{Float_opNeq, FLAG_Method_Const|FLAG_Method_NullBase, CLASS_Float, METHODN_opNeq, 0, 85, NULL},
	{Float_opLt, FLAG_Method_Const, CLASS_Float, METHODN_opLt, 0, 85, NULL},
	{Float_opLte, FLAG_Method_Const, CLASS_Float, METHODN_opLte, 0, 85, NULL},
	{Float_opGt, FLAG_Method_Const, CLASS_Float, METHODN_opGt, 0, 85, NULL},
	{Float_opGte, FLAG_Method_Const, CLASS_Float, METHODN_opGte, 0, 85, NULL},
	{String_opHas, FLAG_Method_Const, CLASS_String, METHODN_opHas, 0, 86, NULL},
	{Pair_opHas, 0, CLASS_Pair, METHODN_opHas, 0, 87, NULL},
	{Pair_opHas, 0, CLASS_Pair, METHODN_opCase, 0, 87, NULL},
	{Range_opHas, 0, CLASS_Range, METHODN_opHas, 0, 87, NULL},
	{Range_opHas, 0, CLASS_Range, METHODN_opCase, 0, 87, NULL},
	{Array_opHas, 0, CLASS_Array, METHODN_opHas, 0, 87, NULL},
	{Array_opHas, 0, CLASS_Array, METHODN_opCase, 0, 87, NULL},
	{Tuple_opHas, 0, CLASS_Tuple, METHODN_opHas, 0, 87, NULL},
	{Tuple_opHas, 0, CLASS_Tuple, METHODN_opCase, 0, 87, NULL},
	{IArray_opHas, 0, CLASS_IArray, METHODN_opHas, 0, 87, NULL},
	{IArray_opHas, 0, CLASS_IArray, METHODN_opCase, 0, 87, NULL},
	{FArray_opHas, 0, CLASS_FArray, METHODN_opHas, 0, 87, NULL},
	{FArray_opHas, 0, CLASS_FArray, METHODN_opCase, 0, 87, NULL},
	{Object_opCase, FLAG_Method_Const|FLAG_Method_NullBase, CLASS_Object, METHODN_opCase, 0, 87, NULL},
	{Int_opCase, FLAG_Method_Const|FLAG_Method_NullBase, CLASS_Int, METHODN_opCase, 0, 87, NULL},
	{Float_opCase, FLAG_Method_Const|FLAG_Method_NullBase, CLASS_Float, METHODN_opCase, 0, 87, NULL},
	{Object_opIs, FLAG_Method_Const, CLASS_Object, METHODN_opIs, 0, 87, NULL},
	{Object_opAs, FLAG_Method_Const, CLASS_Object, METHODN_opAs, 0, 88, NULL},
	{Object_opInTo, FLAG_Method_Const, CLASS_Object, METHODN_opInTo, 0, 82, NULL},
	{Int_opAdd, FLAG_Method_Const, CLASS_Int, METHODN_opAdd, 0, 89, NULL},
	{Int_opNeg, FLAG_Method_Const, CLASS_Int, METHODN_opNeg, 0, 26, NULL},
	{Int_opSub, FLAG_Method_Const, CLASS_Int, METHODN_opSub, 0, 90, NULL},
	{Int_opMul, FLAG_Method_Const, CLASS_Int, METHODN_opMul, 0, 90, NULL},
	{Int_opDiv, FLAG_Method_Const, CLASS_Int, METHODN_opDiv, 0, 90, NULL},
	{Int_opMod, FLAG_Method_Const, CLASS_Int, METHODN_opMod, 0, 90, NULL},
	{Float_opAdd, FLAG_Method_Const, CLASS_Float, METHODN_opAdd, 0, 91, NULL},
	{Float_opNeg, FLAG_Method_Const, CLASS_Float, METHODN_opNeg, 0, 74, NULL},
	{Float_opSub, FLAG_Method_Const, CLASS_Float, METHODN_opSub, 0, 92, NULL},
	{Float_opMul, FLAG_Method_Const, CLASS_Float, METHODN_opMul, 0, 92, NULL},
	{Float_opDiv, FLAG_Method_Const, CLASS_Float, METHODN_opDiv, 0, 92, NULL},
	{String_opAdd, FLAG_Method_Const|FLAG_Method_NullBase, CLASS_String, METHODN_opAdd, 0, 93, NULL},
	{String_opSub, FLAG_Method_Const, CLASS_String, METHODN_opSub, 0, 94, NULL},
	{Any_opAdd, 0, CLASS_Any, METHODN_opAdd, 0, 95, NULL},
	{Any_opAdd, 0, CLASS_Any, METHODN_opSub, 0, 95, NULL},
	{Any_opAdd, 0, CLASS_Any, METHODN_opMul, 0, 95, NULL},
	{Any_opAdd, 0, CLASS_Any, METHODN_opDiv, 0, 95, NULL},
	{Any_opAdd, 0, CLASS_Any, METHODN_opMod, 0, 95, NULL},
	{Any_opNeg, 0, CLASS_Any, METHODN_opNeg, 0, 96, NULL},
	{Boolean_opNot, FLAG_Method_Const, CLASS_Boolean, METHODN_opNot, 0, 27, NULL},
	{Int_opLand, FLAG_Method_Const|FLAG_Method_VarArgs, CLASS_Int, METHODN_opLand, 0, 90, NULL},
	{Int_opLor, FLAG_Method_Const|FLAG_Method_VarArgs, CLASS_Int, METHODN_opLor, 0, 90, NULL},
	{Int_opXor, FLAG_Method_Const, CLASS_Int, METHODN_opXor, 0, 90, NULL},
	{Int_opLnot, FLAG_Method_Const, CLASS_Int, METHODN_opLnot, 0, 26, NULL},
	{Int_opLshift, FLAG_Method_Const, CLASS_Int, METHODN_opLshift, 0, 90, NULL},
	{Int_opRshift, FLAG_Method_Const, CLASS_Int, METHODN_opRshift, 0, 90, NULL},
	...
	{Bytes_get, 0, CLASS_Bytes, METHODN_get, 0, 90, NULL},
	{Bytes_set, 0, CLASS_Bytes, METHODN_set, 0, 97, NULL},
	{Bytes_setAll, 0, CLASS_Bytes, METHODN_setAll, 0, 98, NULL},
	{String_get, FLAG_Method_Const, CLASS_String, METHODN_get, 0, 28, NULL},
	{Array_get, 0, CLASS_Array, METHODN_get, 0, 99, NULL},
	{Tuple_get, 0, CLASS_Tuple, METHODN_get, 0, 100, NULL},
	{IArray_get, 0, CLASS_IArray, METHODN_get, 0, 90, NULL},
	{FArray_get, 0, CLASS_FArray, METHODN_get, 0, 76, NULL},
	{Array_set, 0, CLASS_Array, METHODN_set, 0, 101, NULL},
	{IArray_set, 0, CLASS_IArray, METHODN_set, 0, 102, NULL},
	{FArray_set, 0, CLASS_FArray, METHODN_set, 0, 103, NULL},
	{Array_setAll, 0, CLASS_Array, METHODN_setAll, 0, 104, NULL},
	{IArray_setAll, 0, CLASS_IArray, METHODN_setAll, 0, 105, NULL},
	{FArray_setAll, 0, CLASS_FArray, METHODN_setAll, 0, 106, NULL},
	...
	{Tuple_op0, 0, CLASS_Tuple, METHODN_op0, 0, 96, NULL},
	{Tuple_op1, 0, CLASS_Tuple, METHODN_op1, 0, 96, NULL},
	{Tuple_opN, 0, CLASS_Tuple, METHODN_opN, 0, 100, NULL},
	{Array_op0, 0, CLASS_Array, METHODN_op0, 0, 11, NULL},
	{Array_op1, 0, CLASS_Array, METHODN_op1, 0, 11, NULL},
	{Array_opN, 0, CLASS_Array, METHODN_opN, 0, 99, NULL},
	{IArray_op0, 0, CLASS_IArray, METHODN_op0, 0, 26, NULL},
	{IArray_op1, 0, CLASS_IArray, METHODN_op1, 0, 26, NULL},
	{IArray_opN, 0, CLASS_IArray, METHODN_opN, 0, 90, NULL},
	...
	{OutputStream_putChar, 0, CLASS_OutputStream, METHODN_putChar, 0, 119, NULL},
	...
	{String_equals, FLAG_Method_Const, CLASS_String, METHODN_equals, 0, 86, NULL},
	{String_equals__IgnoreCase, FLAG_Method_Const, CLASS_String, METHODN_equals__IgnoreCase, 0, 86, NULL},
	{String_startsWith, FLAG_Method_Const, CLASS_String, METHODN_startsWith, 0, 86, NULL},
	{String_startsWith__IgnoreCase, FLAG_Method_Const, CLASS_String, METHODN_startsWith__IgnoreCase, 0, 86, NULL},
	{String_endsWith, FLAG_Method_Const, CLASS_String, METHODN_endsWith, 0, 86, NULL},
	{String_endsWith__IgnoreCase, FLAG_Method_Const, CLASS_String, METHODN_endsWith__IgnoreCase, 0, 86, NULL},
	...
	{Regex_opMatch, 0, CLASS_Regex, METHODN_opMatch, 0, 86, NULL},
	...
	{Context_getProperty, FLAG_Method_Static, CLASS_Context, METHODN_getProperty, 0, 142, NULL},
	{Context_setProperty, FLAG_Method_Static, CLASS_Context, METHODN_setProperty, 0, 134, NULL},
	{Context_setEncoding, FLAG_Method_Static, CLASS_Context, METHODN_setEncoding, 0, 115, NULL},
